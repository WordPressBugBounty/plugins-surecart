...
const ScSubscriptionVariationConfirm = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '2479cd5a7263812752bc04d08dd35d59899b3115', heading: this.heading || wp.i18n.__('Enter An Amount', 'surecart'), class: "subscription-switch" }, h("sc-card", { key: '373ccca15a80f68c5a329b2b9e2df22033cd90c7' }, h("sc-form", { key: '613e318362f2c383b4ab32734d37a75ee7860f68', onScSubmit: this.handleSubmit }, h("div", { key: 'd035b0af942defd3a9ec5cf9ef375261963869ea', class: "sc-product-variation-choice-wrap" }, (((_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.variant_options) === null || _b === void 0 ? void 0 : _b.data) || []).map(({ name, values, id }, index) => {
            var _a, _b;
        ...
        })), h("sc-button", { key: 'd4abfc09ef8f898fec2366685e2dd6cd6c62532e', type: "primary", full: true, submit: true, loading: this.busy }, this.buttonText(), " ", h("sc-icon", { key: 'c9a7e0baad949142a62e884d0f1c6d52dab741a7', name: "arrow-right", slot: "suffix" })))), this.busy && h("sc-block-ui", { key: '47a2e10ba0f48a73a2f48cab1d8938e92b09b948', style: { zIndex: '9' } })));
    }
};
