...
const ScForm = class {
    ...
    render() {
        return (h("div", { key: '4bb0f0bbf2ef51b5f69d8407dd6812ab9c31d943', part: "base", class: "form", role: "form" }, h("form", { key: 'ecdb3d8bc3fcd4b43eb850eaa89712b6c9d5cf8d', part: "form", ref: el => (this.formElement = el), class: "test", onSubmit: async (e) => {
                e.preventDefault();
            ...
            }, novalidate: this.novalidate }, h("slot", { key: '51a5833bce902a91104de30888888f33293c99bc' }))));
    }
