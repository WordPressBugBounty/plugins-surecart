...
const ScManualPaymentMethod = class {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: 'e4226e13b5c819058cec8d3231dd09b37ae81239', class: "manual-payment-method", part: "card" }, h("div", { key: 'b88586b294fc36eddfcb30cd166c18796c5089da', class: "payment-method__title" }, (_a = this.paymentMethod) === null || _a === void 0 ? void 0 : _a.name), this.showDescription && h("sc-prose", { key: '844af01b5a4f74803a47c2e23e9624a82776b9a3', class: "payment-method__description", innerHTML: (_b = this.paymentMethod) === null || _b === void 0 ? void 0 : _b.description })));
    }
};
...
const ScProse = class {
    ...
    render() {
        return (h(Host, { key: 'b5d25672f0965fafd066470c4b2aef4dacd44a51' }, h("slot", { key: '7b0f638922d0aa01b4de1ebf9ad02bb7e9d098cc' })));
    }
};
