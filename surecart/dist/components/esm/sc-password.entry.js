...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (h("div", { key: 'a474898503d0261e3fea264e208008683c49b64d', class: "password" }, h("div", { key: '1d67de10ba21b7b24b2ab1ce44c7bb0fd8ca827d' }, h("sc-input", { key: 'b7d53f2c2e87961e26ad2e42e78908bf735a5d28', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && h("small", { key: '7f9ff3eb9bab27944a1c23d0fcffaf31f324602d', class: "password__hint" }, this.hintText)), this.confirmation && (h("div", { key: '9297e10dc86da71e08d1aa515755287fb452717a' }, h("sc-input", { key: '304bdfc1af02e7e714d8fbfdc3add2c143e6aa89', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && h("small", { key: '15b327c09fc3d797a2f1877f60f8e150e82e7871', class: "password__hint" }, this.verifyText)))));
    }
