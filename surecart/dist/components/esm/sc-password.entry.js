...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (h("div", { key: 'b7eb8d82c7e0bc60f15e2f9d80fadbfd7bd1cba8', class: "password" }, h("div", { key: 'f734f95620c2ef1fc85f7af00583f908ef80cbe7' }, h("sc-input", { key: '6c1b690ba93a00d2fd84d822d0bd7b22fce03244', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && h("small", { key: '7e40919a4ddf7f8762d754ddfa4f6de25effc757', class: "password__hint" }, this.hintText)), this.confirmation && (h("div", { key: 'e8023b5575e3c12d56736455a59993fe737fd510' }, h("sc-input", { key: '1d6dc09597c22ac36973befa649e75fd425a6006', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && h("small", { key: '661f281049c1c3bb545dcb134a9d7cfb1851619e', class: "password__hint" }, this.verifyText)))));
    }
