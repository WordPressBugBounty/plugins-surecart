...
const ScRazorpayAddMethod = class {
    ...
    render() {
        return (h(Host, { key: 'cd269d3b31188c50332667d52b6cab095287008c' }, this.error && (h("sc-alert", { key: '2d8176f2a6500b14be1ba880650e9aafd9af20a9', open: !!this.error, type: "danger" }, h("span", { key: '734b8d838ca510c3675e8a16c9c2aa9554d4b200', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h("div", { key: '666b487937150857fae1c7cc25c9d7bcdad4c29b', class: "sc-razorpay-button-container" }, h("sc-alert", { key: '8a2630836ffbe0936ad0aef76ac57255d4d01997', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), h("div", { key: '511ecd465b62e22bb1ba1b3ac0597aa3cb4f5c9e' }, h("sc-button", { key: 'd86f770ad3c5958f17b4fee98ef04525fc053b02', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
