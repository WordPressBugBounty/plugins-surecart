...
const ScRazorpayAddMethod = class {
    ...
    render() {
        return (h(Host, { key: 'c9606ab6db81d0059ab6383e004d9e6c9cb50c47' }, this.error && (h("sc-alert", { key: 'f056e5066ce66d0c1de6277ffb6ae671241be0e1', open: !!this.error, type: "danger" }, h("span", { key: 'd8bcb110dd88dda93a1b04b64495f453259e92c7', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h("div", { key: '14c88762bdadec6781bddc7d8f7b8e24a0d4e13e', class: "sc-razorpay-button-container" }, h("sc-alert", { key: '32ef29c4c162b2599dbe03ce61594d94f7c926c8', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), h("div", { key: 'f05bfba9552d0e29a2a3890d78cbda7433c7c753' }, h("sc-button", { key: 'c7d5a629434c7000d31cc1c54add2676d01a73a4', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
