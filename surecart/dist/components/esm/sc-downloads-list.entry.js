...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (h("sc-dashboard-module", { key: '3253671f37dae39f4ff2fa86f1a80318bee14f4a', class: "purchase", part: "base", heading: wp.i18n.__('Downloads', 'surecart') }, h("span", { key: '0cd2fe59fc36488b3265e01761ca155260c323bc', slot: "heading" }, h("slot", { key: '443858a8134fd6f2ce5de1bd5ad825ca77e40f6a', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), this.renderList(), h("sc-pagination", { key: '941ea1ae1fa8265cc9ad3f3faf27dcb7dd42a3ad', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.downloads) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }), this.busy && h("sc-block-ui", { key: '1721c8f2c8df75ff5845358722e3ba46a7c5aa01' })));
    }
