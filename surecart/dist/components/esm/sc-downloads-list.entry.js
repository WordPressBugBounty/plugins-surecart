...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (h("sc-dashboard-module", { key: 'db12ae39a2be94e8e761233ae45d04f8f238e176', class: "purchase", part: "base", heading: wp.i18n.__('Downloads', 'surecart') }, h("span", { key: 'ce5b67cb69416798c13124df570b0ff2acfc7557', slot: "heading" }, h("slot", { key: '25f3cc689909554641d1ff89e4caf504c705f6ed', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), this.renderList(), h("sc-pagination", { key: '500e74627b05cdc6c184ee33921fe515baf0ae33', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.downloads) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }), this.busy && h("sc-block-ui", { key: 'd29857ad32a63619f242786082696e98d6a456cf' })));
    }
