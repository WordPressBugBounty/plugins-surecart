...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (h("sc-dashboard-module", { key: 'f8868409f8307e350c6801c5f2f4d0b39f6dee3a', class: "purchase", part: "base", heading: wp.i18n.__('Downloads', 'surecart') }, h("span", { key: 'd950621d79e4b1eab0677b19a60e373a666556c2', slot: "heading" }, h("slot", { key: 'd858d5970aac608616e363850e508dd8c0678c27', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), this.renderList(), h("sc-pagination", { key: '1b00fd9c12f3439469bfd3796814b9ef7e15f996', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.downloads) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }), this.busy && h("sc-block-ui", { key: '8d455874b9a2637152c84ed79b6d7c764a83761a' })));
    }
