...
const ScLogin = class {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: '0348ba016b1828f674407dd79e557a1a587d723b', class: "login-form" }, h("sc-card", { key: 'f1c0131c5049b8de1e82a1e35b94ac4e1444984a' }, !!this.error && (h("sc-alert", { key: 'bba6b54baaa860f583cf28bcb934f6086e96201b', open: true, type: "danger", closable: true, onScHide: () => (this.error = null) }, h("span", { key: '430eebfc685a658942b9a430dee717cacbfcddbf', slot: "title", innerHTML: (_a = this.error) === null || _a === void 0 ? void 0 : _a.message }), (((_b = this.error) === null || _b === void 0 ? void 0 : _b.additional_errors) || []).map(({ message }) => (h("div", { innerHTML: message }))))), this.renderInner()), this.loading && h("sc-block-ui", { key: '81a73acc0c27ab67e68e7361d82b8d8119bc9b9b', spinner: true, style: { 'zIndex': '9', '--sc-block-ui-opacity': '0.5' } })));
    }
