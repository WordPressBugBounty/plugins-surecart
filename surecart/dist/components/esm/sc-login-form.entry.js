...
const ScLogin = class {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: '722a3dd754013ddc26de9ccca6a3ca4f95f5dd23', class: "login-form" }, h("sc-card", { key: '4834ff3f80c7081faf406e395f6a38e4a2e8508e' }, !!this.error && (h("sc-alert", { key: 'b9c50b432d849ac12c0dcadbff75c4aa784f8dca', open: true, type: "danger", closable: true, onScHide: () => (this.error = null) }, h("span", { key: '359aa52444662c57693210228ce3e8aa927fe890', slot: "title", innerHTML: (_a = this.error) === null || _a === void 0 ? void 0 : _a.message }), (((_b = this.error) === null || _b === void 0 ? void 0 : _b.additional_errors) || []).map(({ message }) => (h("div", { innerHTML: message }))))), this.renderInner()), this.loading && h("sc-block-ui", { key: '055a3f44bc8f7d84e80274c5e4f5c410d2185133', spinner: true, style: { 'zIndex': '9', '--sc-block-ui-opacity': '0.5' } })));
    }
