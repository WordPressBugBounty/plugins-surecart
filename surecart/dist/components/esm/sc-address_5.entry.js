...
const ScAddress = class {
    ...
    render() {
        ...
        return (h("div", { key: '1d6c243d5b137c2be3a5c0455ad2ace8e7a5c967', class: "sc-address", part: "base" }, h("sc-form-control", { key: '7321c0282bbc45842dd14ce5059c0e22a12a5fdd', label: this.label, exportparts: "label, help-text, form-control", class: "sc-address__control", required: this.required }, topFields.map((field, index) => {
            const roundedProps = this.getRoundedProps(index, totalForRounding);
            return this.renderField(field, roundedProps, this.required);
        }), h("div", { key: 'c41c8dca36c61e5fa80c77a475966e94d2d663b7', class: {
        ...
        }))), this.loading && h("sc-block-ui", { key: '89cd96b06194d308f3fc226741663f359c86bc57', exportparts: "base:block-ui, content:block-ui__content" })));
    }
...
const ScAddressSuggestions = class {
    ...
    render() {
        ...
        return (h("div", { key: 'db08eeeeb37aa2511125be28aa6508a877fba163', part: "base" }, this.isGoogleMapsActive() && h("span", { key: 'a094ad6ebb8b773cae00902de559fa6705aa60b6', class: "sr-only" }, wp.i18n.__('Start typing to see address suggestions, or select one to auto-fill your address.', 'surecart')), h("sc-input", { key: 'c0f14ee61e0a619e001b76550655ea748400c55c', exportparts: "base:input__base, input, form-control, label, help-text", value: this === null || this === void 0 ? void 0 : this.value, onScInput: (e) => this.handleInputChange(e), onScChange: (e) => this.handleInputValueChange(e), autocomplete: "address-line1", placeholder: this.label, "aria-label": this.label, "aria-expanded": suggestionsVisible ? 'true' : 'false', "aria-controls": suggestionsVisible ? 'address-suggestions-listbox' : undefined, "aria-activedescendant": this.getActiveDescendantId(), role: "combobox", name: (_a = this.names) === null || _a === void 0 ? void 0 : _a.line_1, disabled: this.disabled, required: this.required, ...this.inputProps }), h("div", { key: '2f1304af077b1e3a140ecc4183197ee7b29c1d66', role: "status", "aria-live": "polite", "aria-atomic": "true", class: "sr-only" }, this.getSuggestionsStatusText()), h("div", { key: '0963064e027f7be7c61eb0ddbd649eb9417635ae', class: {
...
const ScCheckbox = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '76f19d70c856034829e6a3ae19d5f89cc798d6ef', part: "base", class: {
                'checkbox': true,
            ...
            }, htmlFor: this.inputId, onMouseDown: () => this.handleLabelMouseDown() }, h("span", { key: '07477c48bf391d99df3af33f5dc48bb612ad305e', part: "control", class: "checkbox__control" }, this.checked ? (h("span", { part: "checked-icon", class: "checkbox__icon" }, h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, h("g", { stroke: "currentColor", "stroke-width": "2" }, h("g", { transform: "translate(3.428571, 3.428571)" }, h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" }))))))) : (''), !this.checked && this.indeterminate ? (h("span", { part: "indeterminate-icon", class: "checkbox__icon" }, h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, h("g", { stroke: "currentColor", "stroke-width": "2" }, h("g", { transform: "translate(2.285714, 6.857143)" }, h("path", { d: "M10.2857143,1.14285714 L1.14285714,1.14285714" }))))))) : (''), h("input", { key: 'de95a8551c9211161ed4d29dfd94bde69fca8c51', id: this.inputId, ref: el => (this.input = el), type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, role: "checkbox", "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), h("span", { key: 'a9a65ede6cfc576aa0f6ffe1ee522b2c043474cd', part: "label", id: this.labelId, class: "checkbox__label" }, h("slot", { key: 'c24529265333947e0045c5474e089162575a3c48' }))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'd0fce11f27d5b163a191356b373e230d166544b5', hidden: this.hidden }, h("sc-form-control", { key: '38b673eb8484af02c04735e2d610d7c425d9fa0d', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, h("slot", { key: '14ac5e718ec6a4cdb1c242eedd3f4d0968ed55bd', name: "label-end", slot: "label-end" }), h("div", { key: '13e0e85cd4e2409426338eb977edf01f0ed6c4dc', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: '2ccc3525bf1958181309f71f0213edc631582d86', part: "prefix", class: "input__prefix" }, h("slot", { key: '7dffe92debf23fdeebef1167c4da2686069af9f5', name: "prefix" })), h("slot", { key: '908744115b50673f2888e05f3dfbc20b8e8a1a7a' }, h("input", { key: 'd675a0945fea6ad03b5c3cd7527c2db20d53f096', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), h("span", { key: '598735654a7e3a0afd1b0fc5cd1bbe342b019a1d', part: "suffix", class: "input__suffix" }, h("slot", { key: '21ea897ee5c58a99e0f6a956045d8d5bb7ec9d4d', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: '10c75c86bdf0c8f81a66649e8953ebdd8e5aa104', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: '3497f8eb711a71ee0baa0667f2dec75486318d2b', name: "clear-icon" }, h("svg", { key: '701a5f98012aaffd7034da21d667d06c731977b5', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: '2ba6a0a79ad0560471e41aabb383e4e4c865e417', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: 'b2edd814662f3f730ab5a9932356ab1fe2aa79c5', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Fragment, { key: '3b915028be618bd23593147b9e08f8b3a2e98d4d' }, h("sc-input", { key: 'fbdc6928f47923f0ed0161e1bf74f9368e2591e5', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), h("sc-input", { key: '2b95e51d81b4a80022d55a64eff7c8b2f1c52d55', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
