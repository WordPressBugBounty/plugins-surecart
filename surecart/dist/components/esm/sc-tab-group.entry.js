...
const ScTabGroup = class {
    ...
    render() {
        return (h("div", { key: '7fb4242797f0554372704fd8814614597611aadd', part: "base", class: {
                'tab-group': true,
            }, onClick: e => this.handleClick(e), onKeyDown: e => this.handleKeyDown(e) }, h("div", { key: 'd5f6ce32f065d2bca25768e891db14369a67e348', class: "tab-group__nav-container", part: "nav" }, h("div", { key: 'ee6039f5307a28495f9ed716c818f06ead456412', class: "tab-group__nav" }, h("div", { key: '65496c774a5ca2cc184aeb22117f439e35cf2231', part: "tabs", class: "tab-group__tabs", role: "tablist" }, h("slot", { key: '9b04fe888c7e65a7341fcf71cfaa2907cfb5a49e', onSlotchange: () => this.syncTabsAndPanels(), name: "nav" })))), h("div", { key: '43cf5efaf0195a83f38d4bf7192b41b73cf65c34', part: "body", class: "tab-group__body" }, h("slot", { key: '2491af057b5d44d47634949164d12bdf0e8dea44', onSlotchange: () => this.syncTabsAndPanels() }))));
    }
