...
const ScOrderConfirmation = class {
    ...
    render() {
        var _a, _b;
        return (h(Universe.Provider, { key: '2b577e8efc31a9535053cac06e3648a2514cdcc9', state: this.state() }, h("div", { key: '11e07dbf8476b61b39dadbea3a27064ae8afe942', class: { 'order-confirmation': true } }, h("div", { key: '969371dcbd212edcc8b0900ba03cf23de8c90a33', class: {
                'order-confirmation__content': true,
                'hidden': !((_a = this.order) === null || _a === void 0 ? void 0 : _a.id) && !this.loading,
            } }, h("sc-order-confirm-components-validator", { key: 'a66e1c4b4bfa54c33a2456cbbc21e7149b5e8439', checkout: this.order }, h("slot", { key: '1c7f445218de8f8c22a7c768ab12b7edbb2e20e4' }))), !((_b = this.order) === null || _b === void 0 ? void 0 : _b.id) && !this.loading && (h("sc-heading", { key: '26d652e296c663962892fa8607a6f96802620600' }, wp.i18n.__('Order not found.', 'surecart'), h("span", { key: 'e0b6f05c980f208600c48e027387c9a6b46f186e', slot: "description" }, wp.i18n.__('This order could not be found. Please try again.', 'surecart')))))));
    }
};
