...
const ScChoice = class {
    ...
    render() {
        return (h(Host, { key: '4f3054ed95e113970ce81a486da09edd0bf98fae', tabindex: "0", onFocus: () => this.input.focus() }, h("div", { key: '18f74e505aed89f6e873dde709043ac34aa71800', part: "base", class: {
                'choice': true,
            ...
            }, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, h("slot", { key: 'd0692b4dbb63b5bdf6656592b4842077a7eaf36b', name: "header" }), h("label", { key: 'cfa3724fca27e3ef5ca21949927f7ed92f6b2843', class: "choice__content", part: "content", htmlFor: this.inputId }, h("span", { key: '07b78700f0e62564632d9e2c8169da8754009f58', part: "control", class: {
                choice__control: true,
                choice__checkbox: this.type === 'checkbox',
                choice__radio: this.type === 'radio',
            }, hidden: !this.showControl }, h("span", { key: 'bda104c204a62d17decf2f66bb9831dbfae38634', part: "checked-icon", class: "choice__icon" }, this.type === 'checkbox' ? (h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, h("g", { stroke: "currentColor", "stroke-width": "2" }, h("g", { transform: "translate(3.428571, 3.428571)" }, h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" })))))) : (h("svg", { viewBox: "0 0 16 16" }, h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { fill: "currentColor" }, h("circle", { cx: "8", cy: "8", r: "3.42857143" })))))), h("input", { key: 'db5e6fe1d747e2b3b580ae98950f618e1dba0f9c', id: this.inputId, ref: el => (this.input = el), type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, tabindex: "0",
            // required={this.required}
            onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), h("span", { key: '0ab781a3723b73af741a737fdb5f2a693b7737e7', part: "label", id: this.labelId, class: "choice__label" }, h("span", { key: '15a96c6f9053c85e6b25960bc55a904bcefb7a8e', class: "choice__label-text", hidden: !this.showLabel }, h("span", { key: 'f10f1d7042bff9fb46a45c0e067e438aac7197b4', class: "choice__title", part: "title" }, h("slot", { key: '6966f30c37ca2b23d99be7564aac476e6f1f17fd', onSlotchange: () => this.handleSlotChange() })), h("span", { key: '919422678b33560c59098a23dd3f36816795fdbc', class: "choice__description description", part: "description", hidden: !this.hasDescription }, h("slot", { key: '309da50230f3347d413e62d9ecda4e35c2ef3444', name: "description", onSlotchange: () => this.handleSlotChange() }))), h("span", { key: '35a808a7ff26b769a60c2bd026d71bf94dda58f9', class: "choice__price", hidden: !this.showPrice || (!this.hasPrice && !this.hasPer) }, h("span", { key: '18c8a6ab9dc86d121c62737f7f0a9b177bf84392', class: "choice__title" }, h("slot", { key: 'd1ddd1ed4fecb35ada079ea56749859bf78e4e8a', name: "price", onSlotchange: () => this.handleSlotChange() })), ' ', h("span", { key: '0aa80fea4dfd1ebc5689f477405377fca1cde54d', class: "choice__description" }, h("slot", { key: 'ad4bf25a64f7274a520dfd531acc8046c185b23b', name: "per", onSlotchange: () => this.handleSlotChange() }))))), h("slot", { key: '5d6e65e63291f6679031e1ddf76abf51b0fb5aae', name: "footer" }))));
    }
