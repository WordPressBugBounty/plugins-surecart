...
const ScSwitch = class {
    ...
    render() {
        ...
        return (h(Tag, { key: 'e93ff9fbc97dc9ba1f32e5e99183026d090709ed', part: "base", htmlFor: this.switchId, class: {
                'switch': true,
            ...
            }, onMouseDown: e => this.handleMouseDown(e) }, h("span", { key: '7b4e803480d4a2491d005081ff60b74e884c421c', part: "control", class: "switch__control" }, h("span", { key: '20432d63ed34cff1e12164c4f110e90c58da3a33', part: "thumb", class: "switch__thumb" }), h("input", { key: 'd8a4a58d9951e0269fa25665201a265c4fd1bae2', ref: el => (this.input = el), id: this.switchId, type: "checkbox", role: "switch", name: this.name, value: this.value || 'on', checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onKeyDown: e => this.handleKeyDown(e) })), h("span", { key: '992a9023f8007d43a59295a1202b41a96fa53fa8', class: "switch__label", part: "label" }, h("span", { key: '9bd413809ac85c800c18edbc96c00e1d8133297c', part: "title", id: this.labelId, class: "switch__title" }, h("slot", { key: '2171d54adc5163f156c232cba8f47f18284408f6' })), h("span", { key: 'c6aba6f8432479370e0b5d3044b61fd8042011d8', class: "switch__description", part: "description" }, h("slot", { key: 'c8bf8f61cbebd5b328c6b21441a50a91c1ab0159', name: "description" })))));
    }
