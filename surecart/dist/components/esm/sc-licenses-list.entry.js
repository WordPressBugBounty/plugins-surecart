...
const ScLicensesList = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '4cf97461e1a1d290258a4340e44b89b90cad54ad', class: "purchase", part: "base", error: this.error }, h("span", { key: '435a15864832a7e05c973fa027d3de98da988c91', slot: "heading" }, h("slot", { key: 'd60163e89ee90783775ad1089e2754cc25009079', name: "heading" }, this.heading || wp.i18n.__('License Keys', 'surecart'))), !!this.allLink && !!((_a = this.licenses) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: '533e8c491962f6f480f34d60478589d3dd2b1f27', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: '27f280a181a3b014ef11f185d97a84bb4c293d2c', name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: '39ea4f1e7703d20832f8370a982dce8fc199332e', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.licenses) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }))));
    }
