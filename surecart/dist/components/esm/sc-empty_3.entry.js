...
const ScEmpty = class {
    ...
    render() {
        return (h("div", { key: '8969a5a18b581564a1352faae64fb49626de7360', part: "base", class: "empty" }, !!this.icon && h("sc-icon", { key: '5bd0c3864f6807821e70ad1f98269f65cfe410cd', exportparts: "base:icon", name: this.icon }), h("slot", { key: '8af2a575e27d56a99e028cb84fd0026a70ca4425' })));
    }
};
...
const ScStackedList = class {
    ...
    render() {
        return h("slot", { key: 'aff09b082e9552d3efa4fd1ea38d34a822cc5d66' });
    }
};
...
const ScStackedListRow = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '13ba14e586ce445d52dd757b10e2b11b4b95bd61', href: this.href, target: this.target, part: "base", class: {
                'list-row': true,
            ...
            } }, h("span", { key: 'ab93a40a341053cbb7615d46df81c742f48794c9', class: "list-row__prefix" }, h("slot", { key: 'b10d05d3381dd3a18d1fd1195031a6621472c9a7', name: "prefix", onSlotchange: () => this.handleSlotChange() })), h("slot", { key: '4cb0b7d447d32ee456752a60575072032884e6f4', onSlotchange: () => this.handleSlotChange() }), h("span", { key: '049e4c207b984ea1304650630ea310592eead4fe', class: "list-row__suffix" }, h("slot", { key: '170a6587810b2dddba175d18c6c8ca2d325e4445', name: "suffix", onSlotchange: () => this.handleSlotChange() }))));
    }
