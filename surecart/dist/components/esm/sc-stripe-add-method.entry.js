...
const ScStripeAddMethod = class {
    ...
    render() {
        return (h("sc-form", { key: 'b0f9a274a3eb5d188ba18bb97f28f5694b574c4f', onScFormSubmit: e => this.handleSubmit(e) }, this.error && (h("sc-alert", { key: 'eb4b91f93c6a8e5089cc83ce1afe74d33ce48d2c', open: !!this.error, type: "danger" }, h("span", { key: '0aab644ead23292b91fad4e5cd227d6dd66c0e3d', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h("div", { key: '29051e5d81cd01ed30aa1fc83b36d467b3518646', class: "loader", hidden: this.loaded }, h("div", { key: '3978f7590da8bdbd5578a0559e4ff2c80b474256', class: "loader__row" }, h("div", { key: '89190a4b868b05cc36459a022e67a4b70e4b224d', style: { width: '50%' } }, h("sc-skeleton", { key: 'ce36584c4be74739e08ec6a1667802540e043422', style: { width: '50%', marginBottom: '0.5em' } }), h("sc-skeleton", { key: '9c1be32660378e8fb94a0475a75e9afb2cafad2a' })), h("div", { key: '94adb61d7e1c1d642d838fb85a760249cc144acc', style: { flex: '1' } }, h("sc-skeleton", { key: '5260519f8fb46249ba60b6d8aa9c4bcd8b7abc33', style: { width: '50%', marginBottom: '0.5em' } }), h("sc-skeleton", { key: '0becdaaf876a24aa4484ea9337b259dd0873dbed' })), h("div", { key: 'df039de80e3ac0a87fd985e78fb1ae9650fdad07', style: { flex: '1' } }, h("sc-skeleton", { key: 'a11d49a2183028e26c56bff62922cf75edecb9e4', style: { width: '50%', marginBottom: '0.5em' } }), h("sc-skeleton", { key: 'b40882770815b2652c7bf60caa5a66f8e99edda7' }))), h("div", { key: '709fc27ddbd10c163f86aa3ed99236aa2417f589', class: "loader__details" }, h("sc-skeleton", { key: 'b4ec5b7fbccac54f53ac82a048bd161fdd25ce14', style: { height: '1rem' } }), h("sc-skeleton", { key: 'a6610359b86a450cc430278f26325fa81052733f', style: { height: '1rem', width: '30%' } }))), h("div", { key: '4fe3fb97194731af33c6f0ff38fec3a8229b9964', hidden: !this.loaded, class: "sc-payment-element-container", ref: el => (this.container = el) }), h("sc-button", { key: '895717d2ec8b644be617571ec12063af46f2d6c2', type: "primary", submit: true, full: true, loading: this.loading }, wp.i18n.__('Save Payment Method', 'surecart'))));
    }
