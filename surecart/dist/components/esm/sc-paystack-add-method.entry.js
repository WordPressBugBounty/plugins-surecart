...
const ScPaystackAddMethod = class {
    ...
    render() {
        return (h(Host, { key: 'f9be9de2afc5e2e729c244e442cd1d421505c8e7' }, this.error && (h("sc-alert", { key: '9c6f212a56a2123eca705658d93995780f1aefbc', open: !!this.error, type: "danger" }, h("span", { key: 'f95c756d44854b4d634cdf36a482a05f00936c79', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h("div", { key: '0a1fcf5404ae81e7fe0d136ae39691e474140b2c', class: "sc-paystack-button-container" }, h("sc-alert", { key: '23c5da33b70de4c266f0a3acbd7fee2b9a04c1a1', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), h("div", { key: 'ff1e155805537a7d68d59acdce989e54f610c5f6' }, h("sc-button", { key: '02644f9ccc7a4d129a3db4a011875cb26f27d819', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
