...
const ScPurchaseDownloadsList = class {
    ...
    render() {
        return (h("sc-dashboard-module", { key: '3f1e9d3ebba9301c99bea71e75416dbcd1bbac2c', class: "downloads-list", error: this.error }, h("span", { key: '13b0a3af4727b0d81731a75192b41166957893ad', slot: "heading" }, h("slot", { key: '306eca0ea017f191310fd77d629a67003e308c5a', name: "heading" }, this.heading || wp.i18n.__('Items', 'surecart'))), h("slot", { key: '70fae949356f2d9758ce657ee33f23b4d4bcf359', name: "before" }), !!this.allLink && (h("sc-button", { key: '216b118ce949d7124c2bd0e70b7b416eb8ef2b11', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: 'ee5f60198ad15809de363df35e1106aa86f9fc34', name: "chevron-right", slot: "suffix" }))), this.renderContent(), h("slot", { key: 'd120cc72b69135a7626593183e14dcce19c3cfef', name: "after" }), this.busy && h("sc-block-ui", { key: '9786845e15d32181c3b0275e9ab60ed6273f15c0' })));
    }
