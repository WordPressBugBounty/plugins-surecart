...
const ScPurchaseDownloadsList = class {
    ...
    render() {
        return (h("sc-dashboard-module", { key: '9168d1a863679e4aef367678ca04a19dc2df5e69', class: "downloads-list", error: this.error }, h("span", { key: 'c0ee4c67b7eedb7c2a8bcfa3cde2da0fc8e60d68', slot: "heading" }, h("slot", { key: '8b28dd8d743d286ccdcae7b24592920a38ac1aa2', name: "heading" }, this.heading || wp.i18n.__('Items', 'surecart'))), h("slot", { key: 'eb66ffe1c553cbbdf4632cbea97123dda110e7af', name: "before" }), !!this.allLink && (h("sc-button", { key: 'ce0b8119a48c144feb35dec2e48c06365485fbac', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: 'd0b7dafed106b071ef89c293a5d04e59f487fd9e', name: "chevron-right", slot: "suffix" }))), this.renderContent(), h("slot", { key: '737ad78c53a0d9fa268077c10f4994eece19b124', name: "after" }), this.busy && h("sc-block-ui", { key: '67858a78f28eb946bd945ff0170c1a2275325993' })));
    }
