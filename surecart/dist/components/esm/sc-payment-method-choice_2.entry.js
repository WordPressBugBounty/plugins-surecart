...
const ScPaymentMethodChoice = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '8334112049c19b50d796133324d3737cedd26a3b', "show-control": true, borderless: true, open: this.isSelected(), onScShow: () => {
                state.id = this.processorId;
                state.manual = !!this.isManual;
                state.method = this.methodId;
            } }, this.hasOthers() && h("slot", { key: '901033d5a1699dd2235acf6445ab9ba086945152', name: "summary", slot: "summary" }), this.card && !this.hasOthers() ? (h("sc-card", null, h("slot", null))) : (h("slot", null))));
    }
...
const ScPaymentSelected = class {
    ...
    render() {
        return (h("div", { key: '7ccd9bfaf83d0583c08af6282c2d29eb5882b459', class: "payment-selected", part: "base" }, h("slot", { key: '7ba288c32494189aa2f5fc5abe18f33eade51cba', name: "icon" }), h("div", { key: 'ef2f2146ab0dd394798834bca454ef055e14ee66', class: "payment-selected__label" }, this.label), h("sc-divider", { key: '231cf29ed91892803fdaabc33c9fea418b967112', style: { '--spacing': 'var(--sc-spacing-xx-small)' }, exportparts: "base:divider, line:divider__line" }), h("div", { key: '3035a661a00b6382da529941d9563e52db35cc15', part: "instructions", class: "payment-selected__instructions" }, h("svg", { key: '5c485ed626624b3d56f7ad54ea4e0e61d44537dd', part: "icon", viewBox: "0 0 48 40", fill: "var(--sc-color-gray-500)", xmlns: "http://www.w3.org/2000/svg", role: "presentation" }, h("path", { key: '7d48a1f771b7e6b1354ce0aaa10f7c33450d757d', opacity: ".6", "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M43 5a4 4 0 00-4-4H17a4 4 0 00-4 4v11a1 1 0 102 0V5a2 2 0 012-2h22a2 2 0 012 2v30a2 2 0 01-2 2H17a2 2 0 01-2-2v-9a1 1 0 10-2 0v9a4 4 0 004 4h22a4 4 0 004-4V5zM17.992 16.409L21.583 20H6a1 1 0 100 2h15.583l-3.591 3.591a1 1 0 101.415 1.416l5.3-5.3a1 1 0 000-1.414l-5.3-5.3a1 1 0 10-1.415 1.416zM17 6a1 1 0 011-1h15a1 1 0 011 1v2a1 1 0 01-1 1H18a1 1 0 01-1-1V6zm21-1a1 1 0 100 2 1 1 0 000-2z" })), h("div", { key: 'c473228c989aa59f1726010c88982425bf943da8', part: "text", class: "payment-selected__instructions-text" }, h("slot", { key: 'f4f848f0f5f2d1719dd0e63d4556cf4256e53ab2' })))));
    }
};
