...
import { g as getBundleComponentRowsFromLineItems } from './index-17aac936.js';
...
const ScButton = class {
    ...
    render() {
        ...
        const interior = (h(Fragment, { key: '654e94b67de0cd8c349455f42a02ba3f22cf33a4' }, h("span", { key: 'a8f21993463440796c51ba31887b0dacc3c2d711', part: "prefix", class: "button__prefix" }, h("slot", { key: '443b0b2f9f6f6adfc9c348e646e7422bbcadf034', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), h("span", { key: '248e62de956f04b9e8ef990456b42ac5d6b6c50a', part: "label", class: "button__label" }, h("slot", { key: 'd3d8cc55165ec48fa21105e2aea2b659f91491f4', onSlotchange: () => this.handleSlotChange() })), h("span", { key: '7002d291ed55dea004898b8186cf7646be664fe7', part: "suffix", class: "button__suffix" }, h("slot", { key: 'bdab7f0bf45654187115824568dbb67fdaa27f46', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), this.caret ? (h("span", { part: "caret", class: "button__caret" }, h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("polyline", { points: "6 9 12 15 18 9" })))) : (''), this.loading || this.busy ? h("sc-spinner", { exportparts: "base:spinner" }) : ''));
        return (h(Tag, { key: '156d63314dcaf2108729c328a17d20a06defc588', part: "base", class: {
                'button': true,
...
const ScIcon = class {
    ...
    render() {
        return h("div", { key: '25b571f8e2d520b9e9641907660810da2a969719', part: "base", class: "icon", role: "img", "aria-label": this.getLabel(), innerHTML: this.svg });
    }
...
const ScProductLineItem = class {
    ...
    renderDetails() {
        ...
        return (h("div", { class: {
            ...
            }, part: "details", onClick: () => collapsible && this.toggleDetails() }, h("div", { class: "line-item-details__content" }, rows.map(row => (h("div", { class: "line-item-details__row", part: "details__component", key: row.id }, row.qty > 1 && h("span", { class: "line-item-details__qty" }, row.qty, " \u00D7"), h("span", { class: "line-item-details__name" }, row.name), !!row.variants && (h("span", { class: "line-item-details__variant", part: "details__variant" }, sep, " ", row.variants)))))), collapsible && (h("button", { class: "line-item-details__toggle", type: "button", part: "details__toggle", "aria-expanded": this.detailsExpanded ? 'true' : 'false', onClick: e => {
                e.stopPropagation();
                this.toggleDetails();
            } }, h("span", { class: "line-item-details__toggle-label" }, toggleLabel), h("sc-icon", { class: "line-item-details__toggle-icon", name: "chevron-down", "aria-hidden": "true", style: { width: '16px', height: '16px' } })))));
    }
    render() {
        var _a, _b, _c, _d;
        ...
        return (h("div", { key: '83d9573f96517b1e5589f6ed917e1232d52f44e6', class: "base", part: "base" }, h("div", { key: '1a9fc5b3065201292ca576c542906c69716383c6', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_d = this.image) === null || _d === void 0 ? void 0 : _d.src) ? (h("img", { ...this.image, part: isImageFallback ? 'placeholder__image' : 'image', class: isImageFallback ? 'item__image-placeholder' : 'item__image' })) : (h("div", { class: "item__image-placeholder", part: "placeholder__image" })), h("div", { key: '46e4e94c95be8949922be91eabd354324445820c', class: "item__text-container" }, h("div", { key: '8a092d0b25ed8f08feea9f4d5d2283bcb4a88017', class: "item__row" }, h("div", { key: '99f2a5b72d749bac8fb169a2d0424340b7baa777', class: "item__title", part: "title" }, h("slot", { key: '6b5a077ca5acced18163ff6f0b3ad66cb9129b7e', name: "title" }, this.name), bundleCount > 0 && (h("span", { key: '3a310ffe710600c73e59905789864a1f762b0d03', class: "item__title-count", "aria-hidden": "true" }, "(", bundleCount, ")")), bundleCount > 0 && h("span", { key: 'afd855d2f64476c6a02f52181303f0febd1aa3f7', class: "visually-hidden" }, wp.i18n.sprintf(wp.i18n._n('Includes %d item', 'Includes %d items', bundleCount, 'surecart'), bundleCount))), h("div", { key: 'a4a0b90d1faaf3b9bd4b303bc71f1cdfffe77911', class: "price", part: "price__amount" }, !!this.scratch && this.scratch !== this.amount && h("span", { key: '742fa88c625a4388bb556b8ee32fed9eefd8f630', class: "item__scratch-price" }, this.scratch), this.amount, h("div", { key: 'a4c7b0d1852a0ea3d1e17458c70c017cef2b43bb', class: "price__description", part: "price__description" }, this.interval))), hasMetaRow && (h("div", { key: 'b5aabb2e2d0cc5fd936656124336b05f99cf0100', class: "item__row" }, h("div", { key: 'f6f152b2ddcba92b6c8d2ecda0f49e4c8b8dd6ed', class: "item__description", part: "description" }, this.variant && h("div", { key: 'd499b9a0390314f3f7fde5b876d4a2946d59bd6a' }, this.variant), this.price && h("div", { key: '12394beab31dd51be37c885b7c023159c312ebf8' }, this.price), this.sku && (h("div", { key: '7f57930476202c91a6b360beb72996f0fa940fe1' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku)), !!this.purchasableStatus && h("div", { key: 'e69060d0491f81ac9825b5c29c6c0c58114756ad' }, this.purchasableStatus)), h("div", { key: '20d21e071cbedd6e9832c28e1654ae6ed0535d3e', class: "item__description", part: "trial-fees" }, !!this.trial && h("div", { key: '8bb86047207a23fd3327943b8e0eeec018b3f93b' }, this.trial), (this.fees || []).map(fee => {
            return (h("div", null, fee === null || fee === void 0 ? void 0 :
                fee.display_amount, " ", fee === null || fee === void 0 ? void 0 :
                fee.description));
        })))), this.renderDetails(), !!this.note && (h("div", { key: '43e4128b6f44b4eb9f118f00a32fdbe2fdc65857', class: "item__description" }, h("sc-product-line-item-note", { key: '4a94e30b0530426c99df5faeb5195385c3f628aa', note: this.note, exportparts: "base:note" }))), h("div", { key: 'a0629cdd7906c2eebe12b3457eeac878842565ed', class: "item__row stick-bottom" }, this.editable ? (h("sc-quantity-select", { max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.price), productName: this.name })) : (h("span", { class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity)), !!this.reviewButtonLink && (h("div", { key: '3cc3d05585054334d3995e440de0a0523184ce34', class: "item__add-review" }, h("sc-button", { key: 'c26a69bfd4605193113a240b4fa33bd6c69eed21', size: "small", href: this.reviewButtonLink, target: "_blank" }, wp.i18n.__('Review Product', 'surecart')))), !!this.removable && (h("div", { key: 'ea6d312c2ec917b332c30ab46128b74f37b37f43', class: "item__remove-container", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
            }, "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %1$s %2$s', 'surecart'), this.name, this.amount), tabIndex: 0 }, h("sc-icon", { key: 'b0b99a1488432d4b6577322b912a3dc5246fc170', exportparts: "base:remove-icon__base", class: "item__remove", name: "x" }), h("span", { key: 'ba58e3c57316d646ad85cf2de19fb61008076704', class: "item__remove-text" }, wp.i18n.__('Remove', 'surecart')))))))));
    }
...
const ScQuantitySelect = class {
    ...
    render() {
        return (h("div", { key: 'f87d0e717cca0f093b8cd46001668ee45acd602e', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, h("button", { key: 'b87e536709d9facd789600480e15e491ed8f59e4', part: "minus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Decrease %1$s quantity by one', 'surecart'), this.productName), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, h("sc-icon", { key: '587cea8b0c6b06b0ddee6b88dd610f3363066f0a', name: "minus", exportparts: "base:minus__icon" })), h("input", { key: 'ab04a8b9dde3ce3960f4d5f83d5902fc692a1815', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Quantity input for %1$s product', 'surecart'), this.productName) }), h("button", { key: '969d9da1d6cac9d9aa484b1a3b1983f0325c65fb', part: "plus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Increase %1$s quantity by one', 'surecart'), this.productName), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, h("sc-icon", { key: '498ee6e4edac91ab06c2f13fe8b4df553b98a34a', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return getElement(this); }
};
...
const ScSpinner = class {
    ...
    render() {
        return h("span", { key: '2ee97812cfb75bbdc7b60de3552494267e4480ac', part: "base", class: "spinner", "aria-busy": "true", "aria-live": "polite" });
    }
};
