...
const ScButton = class {
    ...
    render() {
        ...
        const interior = (h(Fragment, { key: '84d023e2186c1abc388d1de326806f9a8a658808' }, h("span", { key: 'c32560928901007caed8336c15d0f663be0f09f7', part: "prefix", class: "button__prefix" }, h("slot", { key: '46de2a01772f62073e3d08135d5b96d14243918a', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), h("span", { key: '5db06a1370062fa8e1d23d40f876192e436a87ce', part: "label", class: "button__label" }, h("slot", { key: 'e7fcc1fa23f9c0c277e66332cedd5958b7a3d64d', onSlotchange: () => this.handleSlotChange() })), h("span", { key: '4a3b90458d4751d4f80942e792c55d18370f2173', part: "suffix", class: "button__suffix" }, h("slot", { key: '5b45213af863a205f706e0462650ab6c87f24a9e', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), this.caret ? (h("span", { part: "caret", class: "button__caret" }, h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("polyline", { points: "6 9 12 15 18 9" })))) : (''), this.loading || this.busy ? h("sc-spinner", { exportparts: "base:spinner" }) : ''));
        return (h(Tag, { key: '25a87670748d993aeab7bf5f045f48de4cea6b54', part: "base", class: {
                'button': true,
...
const ScIcon = class {
    ...
    render() {
        return h("div", { key: '18d7d08cbf7a046767fcb296769c3a403af6c46b', part: "base", class: "icon", role: "img", "aria-label": this.getLabel(), innerHTML: this.svg });
    }
