...
const ScButton = class {
    ...
    render() {
        ...
        const interior = (h(Fragment, { key: '5b762ef47b6b3bbf29d1f984b844aad90beeac42' }, h("span", { key: '0cb7ae4799035b09b8a99442c15c4916ab35ec7f', part: "prefix", class: "button__prefix" }, h("slot", { key: '0bce29b8cc0e080d12fa220f6ad0dc013f48ef84', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), h("span", { key: '6a0e818e77794c4d932de2fbcbead450b365e564', part: "label", class: "button__label" }, h("slot", { key: '4db77e4ed55d5319adc55bf42b8f16e726a17891', onSlotchange: () => this.handleSlotChange() })), h("span", { key: 'add9890593144a987e3842b10f8396da92dcea39', part: "suffix", class: "button__suffix" }, h("slot", { key: '71d7cdd464ab23c14098a060c54ad9a28dc381fe', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), this.caret ? (h("span", { part: "caret", class: "button__caret" }, h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("polyline", { points: "6 9 12 15 18 9" })))) : (''), this.loading || this.busy ? h("sc-spinner", { exportparts: "base:spinner" }) : ''));
        return (h(Tag, { key: '70828cdee0eadef6b684e4737269becd8a37428f', part: "base", class: {
                'button': true,
...
const ScIcon = class {
    ...
    render() {
        return h("div", { key: 'a06a0dce3ba7bc5d10cd0eac3c045fbcfd571727', part: "base", class: "icon", role: "img", "aria-label": this.getLabel(), innerHTML: this.svg });
    }
...
const ScProductLineItem = class {
    ...
    render() {
        ...
        return (h("div", { key: 'a65243624d09fe862aef581d466acb55ef5efacf', class: "base", part: "base" }, h("div", { key: 'b39ebb59fd72c32e5abcbfc13dbeb714a512d310', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_d = this.image) === null || _d === void 0 ? void 0 : _d.src) ? (h("img", { ...this.image, part: isImageFallback ? 'placeholder__image' : 'image', class: isImageFallback ? 'item__image-placeholder' : 'item__image' })) : (h("div", { class: "item__image-placeholder", part: "placeholder__image" })), h("div", { key: 'c1a5b43cb13c7e22b210fb5c8e72e5705c18283b', class: "item__text-container" }, h("div", { key: '440283d3c69e3c00bc9e621ff4399deaaf138ce0', class: "item__row" }, h("div", { key: '4e20db7f1f0de0e2ad3ac83419e1e9992e81865c', class: "item__title", part: "title" }, h("slot", { key: '721f42c7974f00d69bcbf6ab352c5ebc4dbfda2a', name: "title" }, this.name), bundleCount > 0 && (h("span", { key: '2bf0aa90806baaf96a7e431d6c8cc89bfca115cb', class: "item__title-count", "aria-hidden": "true" }, "(", bundleCount, ")")), bundleCount > 0 && h("span", { key: 'a9fb018c35c59c84fc9d384ad55421c393cdcedf', class: "visually-hidden" }, wp.i18n.sprintf(wp.i18n._n('Includes %d item', 'Includes %d items', bundleCount, 'surecart'), bundleCount))), h("div", { key: 'fac8267658fa3d0f2404bac5dbe14a42a889bdde', class: "price", part: "price__amount" }, !!this.scratch && this.scratch !== this.amount && h("span", { key: '30fee66123ba2ffe78f046a35e01d511893e41f8', class: "item__scratch-price" }, this.scratch), this.amount, h("div", { key: '17866b2a1726e37a7702c07c6c70b421a840e2ba', class: "price__description", part: "price__description" }, this.interval))), hasMetaRow && (h("div", { key: '1a5a28ecb84b53cd146b1631cd774b2606617ec0', class: "item__row" }, h("div", { key: 'a45f43c4242ecad028573dd69f14e95c11459b49', class: "item__description", part: "description" }, this.variant && h("div", { key: 'd34b96ce945bda782bc67bd857227461f6e0edc3' }, this.variant), this.price && h("div", { key: 'd147a44d161794dc2c4723690cdf54d92463b0ab' }, this.price), this.sku && (h("div", { key: '116052ba46585c5a2ed0d0b189ede3a7e4660f10' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku)), !!this.purchasableStatus && h("div", { key: '0c5798a695fc8c297a90497180bb6463d9054a73' }, this.purchasableStatus)), h("div", { key: 'e761b5eae754a84b62d46e161ebc8bba21c78e62', class: "item__description", part: "trial-fees" }, !!this.trial && h("div", { key: '3ef832b402eaeee604e588718cc1d554d2d8cd03' }, this.trial), (this.fees || []).map(fee => {
            return (h("div", null, fee === null || fee === void 0 ? void 0 :
                fee.display_amount, " ", fee === null || fee === void 0 ? void 0 :
                fee.description));
        })))), this.renderDetails(), !!this.note && (h("div", { key: '74f3ebf46c45173b3ed33f0689c4d720bbbdac1e', class: "item__description" }, h("sc-product-line-item-note", { key: '9c858d99e522afbd364b9f176c34a405bc24edd2', note: this.note, exportparts: "base:note" }))), h("div", { key: '9a98f1f2421b864457939b2ff627e4c4feef9db9', class: "item__row stick-bottom" }, this.editable ? (h("sc-quantity-select", { max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.price), productName: this.name })) : (h("span", { class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity)), !!this.reviewButtonLink && (h("div", { key: 'd9f180f5d6869fca26e5036be5072c080eb8aeb8', class: "item__add-review" }, h("sc-button", { key: '08911a2bf2c75444ae38e4595f87a30ac96b7374', size: "small", href: this.reviewButtonLink, target: "_blank" }, wp.i18n.__('Review Product', 'surecart')))), !!this.removable && (h("div", { key: '126bdc92f322099dc34840f9aa2fe1fdf7e3e018', class: "item__remove-container", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
            }, "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %1$s %2$s', 'surecart'), this.name, this.amount), tabIndex: 0 }, h("sc-icon", { key: '5a9f27dfce9141293ee549e955573c20c5a80b64', exportparts: "base:remove-icon__base", class: "item__remove", name: "x" }), h("span", { key: '243a2f23230cf535c60b243ea4b8e5a9ff87cc74', class: "item__remove-text" }, wp.i18n.__('Remove', 'surecart')))))))));
    }
...
const ScQuantitySelect = class {
    ...
    render() {
        return (h("div", { key: '19b66b6f96b00ea845304b6fefd30386b1118eca', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, h("button", { key: '620fb5c3e1e2fa235268f21129f9d91d5e9fd150', part: "minus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Decrease %1$s quantity by one', 'surecart'), this.productName), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, h("sc-icon", { key: '5d6853c4f2404650fe51bd49d2b8f308c42daa30', name: "minus", exportparts: "base:minus__icon" })), h("input", { key: '069395602cddc53407a67dc9878714740fb63028', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Quantity input for %1$s product', 'surecart'), this.productName) }), h("button", { key: 'f751adf2e7dfe00bda8e407dc9a481fadcf95a1e', part: "plus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Increase %1$s quantity by one', 'surecart'), this.productName), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, h("sc-icon", { key: '3b561eb47a58b85e02732d838c057cc0bb2acfa4', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return getElement(this); }
};
...
const ScSpinner = class {
    ...
    render() {
        return h("span", { key: '64d808a3cb66beaf93e597d81636cbd516b8559b', part: "base", class: "spinner", "aria-busy": "true", "aria-live": "polite" });
    }
};
