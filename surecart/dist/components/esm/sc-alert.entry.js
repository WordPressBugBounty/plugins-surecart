...
const ScAlert = class {
    ...
    render() {
        return (h(Host, { key: '70789ac3b41ee048fc51550c09d5272d4b864c86', style: { 'scroll-margin-top': this.scrollMargin } }, h("div", { key: 'ab22fe9d310aeac2b869940ef1b81bbbd1be7b46', class: {
                'alert': true,
                ...
                'alert--is-rtl': isRtl()
            }, part: "base", role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', hidden: this.open ? false : true, onMouseMove: () => this.handleMouseMove() }, h("div", { key: '22e6985c387b9b151ee1054aadd28cef4915b095', class: "alert__icon", part: "icon" }, h("slot", { key: 'ed83fd736715591b0aeb67f0df7c23df0a3b606a', name: "icon" }, this.icon())), h("div", { key: '30d8e1587d47d9484f11d347c56c597a879c5048', class: "alert__text", part: "text" }, h("div", { key: '7d802794b939c0775a2a0e1973b268589f37c050', class: "alert__title", part: "title" }, h("slot", { key: 'bd2e241284042b88f3a7a937e72074c6204be851', name: "title" }, this.title)), h("div", { key: 'fd3574d439de943b927517f92cf0b26deef37db5', class: "alert__message", part: "message" }, h("slot", { key: 'ff9f98a1a79b2e898dcb13c9033b78a8fd49d08f' }))), this.closable && (h("span", { key: 'f33a6ba5b5252d96076ad7ff805650612aed8fc9', part: "close", class: "alert__close", onClick: () => this.handleCloseClick() }, h("span", { key: '2a43b3c8d6d0340e587f854a4b8d5bae81abc624', class: "sr-only" }, "Dismiss"), h("svg", { key: 'c762cfbcc1f64de0a35f0cd633449175b79fcd67', class: "h-5 w-5", "x-description": "Heroicon name: solid/x", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, h("path", { key: 'bec6ff92e8cbf43b042c67f04a76e53c9b060b68', "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))));
    }
