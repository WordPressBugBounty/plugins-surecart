...
const ScAlert = class {
    ...
    render() {
        return (h(Host, { key: 'eb38d9a78bc58f1a5f06a86e4563251e5763bcfe', style: { 'scroll-margin-top': this.scrollMargin } }, h("div", { key: 'b9acb5a98762dc0b299c7c7e7baa311eb697275d', class: {
                'alert': true,
                ...
                'alert--is-rtl': isRtl()
            }, part: "base", role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', hidden: this.open ? false : true, onMouseMove: () => this.handleMouseMove() }, h("div", { key: 'ec672f9c676366847e0ba9aed43d46b2f3bb7857', class: "alert__icon", part: "icon" }, h("slot", { key: 'c764b761a089708f27481219a94fb3232ddff8e9', name: "icon" }, this.icon())), h("div", { key: 'd239d8e46f463b269199134c2ce4be740f75a3b8', class: "alert__text", part: "text" }, h("div", { key: '3146cee86b9d74c69f3e9f6c4edee0fd2279443d', class: "alert__title", part: "title" }, h("slot", { key: 'fbb87544f654c9a1608243d25acab7707417d49c', name: "title" }, this.title)), h("div", { key: '54c21df57b4da474559cf8b123f3b4fbd42e2607', class: "alert__message", part: "message" }, h("slot", { key: 'c02b9b6f35ca375360ccca8b04ddd93938bc6cb3' }))), this.closable && (h("span", { key: '80f6255909971b9dad16fb395da46655c3024ef7', part: "close", class: "alert__close", onClick: () => this.handleCloseClick() }, h("span", { key: 'c11108a3f8093b63352e12ea4500f75707d3caef', class: "sr-only" }, "Dismiss"), h("svg", { key: '016f320c81fbd330ce66077f4a30f660762d545f', class: "h-5 w-5", "x-description": "Heroicon name: solid/x", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, h("path", { key: '652574942f5efc36d9de833e740b79eaef06f350', "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))));
    }
