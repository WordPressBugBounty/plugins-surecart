...
const ScAlert = class {
    ...
    render() {
        return (h(Host, { key: '9a223d588e07cc29dbbdc33aa947b72378e2e6fc', style: { 'scroll-margin-top': this.scrollMargin } }, h("div", { key: 'df8ac6985e9370b40f3902f3a47aeb29cb4c4698', class: {
                'alert': true,
                ...
                'alert--is-rtl': isRtl()
            }, part: "base", role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', hidden: this.open ? false : true, onMouseMove: () => this.handleMouseMove() }, h("div", { key: '26246a414b434097049ced05ada7da7c7054ada4', class: "alert__icon", part: "icon" }, h("slot", { key: '35c43ae0fdc90a34d864dc798bab9ff7b70988af', name: "icon" }, this.icon())), h("div", { key: '1427215415de552e1eb9c480a0f1fc611883ccba', class: "alert__text", part: "text" }, h("div", { key: '1cf69eec607b2c40b62856febb8429a485325930', class: "alert__title", part: "title" }, h("slot", { key: 'e4fc4014cf191120cdd9b0c378546480ab401785', name: "title" }, this.title)), h("div", { key: '2325bb694a81e9b9d79ea8af7de8a8cb58b02b20', class: "alert__message", part: "message" }, h("slot", { key: '87c8eefb1498cefb9a8cd32d7a090eb4627c743b' }))), this.closable && (h("span", { key: '7b37c24e49f4f79a4965459f2061d5c6afba72d3', part: "close", class: "alert__close", onClick: () => this.handleCloseClick() }, h("span", { key: 'beaedd9b4d6e441d6daac90d56a0335a34435bdf', class: "sr-only" }, "Dismiss"), h("svg", { key: '5c8b2376f7edf0a62a5f36fc4942ffadc93256f2', class: "h-5 w-5", "x-description": "Heroicon name: solid/x", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, h("path", { key: 'f718db0f297232fcd890f713f4796db9310927a1', "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))));
    }
