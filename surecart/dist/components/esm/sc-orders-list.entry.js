...
const ScOrdersList = class {
    ...
    renderList() {
        return this.orders.map(order => {
            ...
            return (h("sc-stacked-list-row", { href: addQueryArgs(window.location.href, {
                ...
                } }, wp.i18n.sprintf(wp.i18n._n('%s item', '%s items', itemsCount, 'surecart'), itemsCount))), h("div", { class: "orders-list__status" }, this.renderStatusBadge(order), h("sc-order-shipment-badge", { context: "customer", status: order === null || order === void 0 ? void 0 : order.shipment_status })), h("div", null, amount_due_display_amount)));
        });
    }
    renderContent() {
        var _a;
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: 'bfab8d6961b20263e57602e2f7f257cd4a16b23b', class: "orders-list", error: this.error }, h("span", { key: 'b5f008cf73054a9410ecac591c50c7e4b26ed247', slot: "heading" }, h("slot", { key: '44326834d38436f25b5f13e144b41f91ddbb5b38', name: "heading" }, this.heading || wp.i18n.__('Order History', 'surecart'))), !!this.allLink && !!((_a = this.orders) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: '431dfb20a76d11fe91a9adc0c4739ee54b4809ac', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Order History', 'surecart')) }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: '200cc8026512b9c8ee1e1bfe4ba4416ff102419f', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: '4d8d16f62d218f5ab5cd75d4142433c7829958bf', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.orders) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && h("sc-block-ui", { key: 'ea581d4e28693977521e5fc01f06a5cfe65cc98d' })));
    }
