...
const ScProvisionalBanner = class {
    ...
    render() {
        return (h("div", { key: '503a53298166848572fb806ba2daa97f288c3eed', class: { 'sc-banner': true } }, h("p", { key: '7523afd8a089aec9205a54c5046e7290453f5b93' }, this.expired
            ? wp.i18n.__('The setup window for your store has expired. Please contact support to complete your setup.', 'surecart')
            : wp.i18n.__('Complete your store setup to go live.', 'surecart'), !this.expired && (h("a", { key: '742bf9c3f659583e0ecd671f087961fcee045b21', href: this.claimUrl, target: "_blank", rel: "noopener noreferrer" }, wp.i18n.__('Complete Setup', 'surecart'), " ", h("sc-icon", { key: 'd5a90ea4ebbdad676e919a8e24503721b58929bc', name: "arrow-right" }))))));
    }
};
