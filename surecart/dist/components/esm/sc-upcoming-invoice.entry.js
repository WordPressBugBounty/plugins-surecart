...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (h("div", { key: 'e9174b3abedaa81c9b674e4713313b41bca38d2a', class: "upcoming-invoice" }, this.error && (h("sc-alert", { key: '061f7a6ecca9700a510c85b83f938f061ba45183', open: !!this.error, type: "danger" }, h("span", { key: '0fd5b85ededd19e999dbb9a9e47cc6e71f37987b', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h(Fragment, { key: 'ccf84eab6add960a5c333b2e24f99fd8d8fe7228' }, h("sc-dashboard-module", { key: '29c913e58a896341fcd4764e7be72916894d5563', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, h("sc-card", { key: '3ed0c69dc0086a6d93852ca765240b72bf8c4777' }, this.renderContent())), h("sc-dashboard-module", { key: '12e7e8f4e5fbda9c422dd3bbdce89d0d1cf3af93', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, h("sc-form", { key: '4967bfe132cca5b046c8ceabc92bfcfb1a805a77', onScFormSubmit: () => this.onSubmit() }, h("sc-card", { key: '01ebec34accf720c4c5f4adc571fbd630fbe317a' }, this.renderSummary()), h("sc-button", { key: 'c4540fc309959bc646995b5711cb75a0298f8004', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), h("sc-text", { key: '003ed6dbec052d8db83a3851be5be2555cdcde9d', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, h("slot", { key: 'bde272ac6ce9d04df40f1da2920d8d91af1199f9', name: "terms" }))), this.busy && h("sc-block-ui", { key: '7f63c1c85419dd2d53ba7618dd9164f273e5a8c8' })));
    }
