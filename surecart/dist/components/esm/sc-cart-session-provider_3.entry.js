...
const ScDrawer = class {
    ...
    render() {
        return (h("div", { key: '70d7e22dd4cbdf41636ae7710b05112b96cce7f9', part: "base", class: {
                'drawer': true,
