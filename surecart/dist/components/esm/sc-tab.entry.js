...
const ScTab = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '76cf3c1b94810a28ca4b9d339e1a42a4dae6bfa6', part: `base ${this.active ? `active` : ``}`, href: this.href, class: {
                'tab': true,
                ...
                'tab--is-rtl': isRtl(),
            }, ref: el => (this.tab = el), role: "tab", "aria-disabled": this.disabled ? 'true' : 'false', "aria-selected": this.active ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0' }, h("span", { key: '6fb9e1427f4c6b68f2475b01c1ae36e76f94e30c', part: "prefix", class: "tab__prefix" }, h("slot", { key: '4f68367db2fe811eeb6744c354f2ca115efa9270', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), h("div", { key: '20d42ae2300c9a7778d429a057f66c32ac772f18', class: "tab__content", part: "content" }, h("slot", { key: '07d27d810a9b794d35e41fec2f4d7d3f8cf999bd' })), h("span", { key: '4f81725b75c0dcad8efe1f1035586e2fa566363a', part: "suffix", class: "tab__suffix" }, h("slot", { key: 'e38a6fcacf5f9e601ede3d9bb2c7c9b12341bd7a', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), h("slot", { key: '76f88527e06d14703a2f697cddfc443dd3833867', name: "suffix" }, !!this.count && (h("div", { key: '7186ef235564e72254aa5a9dd2ac26c285f7785a', class: "tab__counter", part: "counter" }, this.count)))));
    }
