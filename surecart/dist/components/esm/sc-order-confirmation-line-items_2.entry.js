...
const ScOrderConfirmationTotals = class {
    ...
    render() {
        ...
        return (h("div", { key: '3d51dff5f50a0156d5cd3b718e184799ac4d6aea', class: { 'line-item-totals': true } }, ((_c = this.order) === null || _c === void 0 ? void 0 : _c.subtotal_amount) !== ((_d = this.order) === null || _d === void 0 ? void 0 : _d.total_amount) && (h(Fragment, { key: 'aa5aa12268fe52f0677a16bd276fe0365aa736c3' }, h("sc-line-item", { key: '20c31d3288ac886ed8a1a86e617371b3625a5345' }, h("span", { key: '6f4a95226349d648a5161dd8b413b9f0b94025b2', slot: "description" }, wp.i18n.__('Subtotal', 'surecart')), h("span", { key: '7cba2aa13135c52ca27c5baecbd45886531dfd88', slot: "price", style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            } }, (_e = this.order) === null || _e === void 0 ? void 0 : _e.subtotal_display_amount)), this.renderCheckoutFees(this.order))), !!((_f = this.order) === null || _f === void 0 ? void 0 : _f.trial_amount) && (h("sc-line-item", { key: '60576f66cfcdbd78c8048761cc20da043fb45d0a' }, h("span", { key: 'e86e7d1320db8ed0635ebd7ba65dfbd35bb3a0f8', slot: "description" }, wp.i18n.__('Trial', 'surecart')), h("span", { key: '53bb2bcf01e41684e29a0b1f9e685c98a6d4b675', slot: "price", style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            } }, (_g = this.order) === null || _g === void 0 ? void 0 : _g.trial_display_amount))), !!((_h = this.order) === null || _h === void 0 ? void 0 : _h.discounts) && (h("sc-line-item", { key: '5d401992646d257736444307576dcddb968ea48d' }, h("span", { key: 'f38f177547c3a8b6d86747fc0c62b6ef06ac3a27', slot: "description" }, wp.i18n.__('Discounts', 'surecart')), h("span", { key: '48c58acd38a309fc877de67c94023235afab7a68', slot: "price", style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            } }, (_j = this.order) === null || _j === void 0 ? void 0 : _j.discounts_display))), !!((_m = (_l = (_k = this.order) === null || _k === void 0 ? void 0 : _k.discount) === null || _l === void 0 ? void 0 : _l.promotion) === null || _m === void 0 ? void 0 : _m.code) && (h("sc-line-item", { key: '3d74dc005bd4cef69659323a08615f61666c5554' }, h("span", { key: '0bcb84c3a2de2a4834e7020967cd65d3d5e58441', slot: "description" }, wp.i18n.__('Discount', 'surecart'), h("br", { key: 'ba0255c726780c480bad908e353f3052a6723418' }), h("sc-tag", { key: '693895c38ad0e7a0daddc6a8db337f34a62de353', type: "success" }, wp.i18n.__('Coupon:', 'surecart'), " ", (_q = (_p = (_o = this.order) === null || _o === void 0 ? void 0 : _o.discount) === null || _p === void 0 ? void 0 : _p.promotion) === null || _q === void 0 ? void 0 :
            _q.code)), h("span", { key: 'c47be1b86f340f5292c133da4d5e3b8ce00ab2c5', slot: "price", style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            } }, (_r = this.order) === null || _r === void 0 ? void 0 : _r.discounts_display_amount))), !!((_s = this.order) === null || _s === void 0 ? void 0 : _s.shipping_amount) && (h(Fragment, { key: '3cf7899a67612e08fc19d133210a0d944a1b4fde' }, h("sc-line-item", { key: 'c6249962d6fa1f47fc910e1dac9829a511388a17' }, h("span", { key: '82fb6275abfb7c1f6f652c8d9482182c2dfb4be5', slot: "description" }, `${wp.i18n.__('Shipping', 'surecart')} ${shippingMethodName ? `(${shippingMethodName})` : ''}`), h("span", { key: 'f82a79978ccb568a28b7b21f8c9f80b5768f9c52', slot: "price", style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            } }, (_t = this.order) === null || _t === void 0 ? void 0 : _t.shipping_display_amount)), this.renderShippingFees(this.order))), !!((_u = this.order) === null || _u === void 0 ? void 0 : _u.tax_amount) && (h("sc-line-item", { key: '33966cb1cec28226824e8514ba9c2f7e3fc5927b' }, h("span", { key: '6a6d918077f1b6d99fd03d611868d881d634e280', slot: "description" }, `${formatTaxDisplay((_v = this.order) === null || _v === void 0 ? void 0 : _v.tax_label, ((_w = this.order) === null || _w === void 0 ? void 0 : _w.tax_status) === 'estimated')} (${(_x = this.order) === null || _x === void 0 ? void 0 : _x.tax_percent}%)`), h("span", { key: '398d69ce69ab60446e55f9583a82f2ec79fe465e', slot: "price" }, (_y = this.order) === null || _y === void 0 ? void 0 : _y.tax_display_amount), !!((_z = this.order) === null || _z === void 0 ? void 0 : _z.tax_inclusive_amount) && h("span", { key: '1e113bd159de07af7e97926dbed226b3f1f4dcee', slot: "price-description" }, `(${wp.i18n.__('included', 'surecart')})`))), h("sc-divider", { key: '4a48337b33fd456fd9620aa2c6b5d15a3ae429ac', style: { '--spacing': 'var(--sc-spacing-x-small)' } }), h("sc-line-item", { key: 'e98dc0c688e9529389ff5052c56c53db79f37b4f', style: {
                'width': '100%',
                '--price-size': 'var(--sc-font-size-x-large)',
            } }, h("span", { key: 'ebe7644ea216f080cbcd27a502c5d49acce965f2', slot: "title" }, wp.i18n.__('Total', 'surecart')), h("span", { key: '6856d7dfe3c510a027556c3138d3dd9e49cacd5c', slot: "price" }, (_0 = this.order) === null || _0 === void 0 ? void 0 : _0.total_display_amount), h("span", { key: 'dd6241b9e2539e2d73d9c8948ebb9d0487affe5f', slot: "currency" }, (_1 = this.order) === null || _1 === void 0 ? void 0 : _1.currency)), !!((_2 = this.order) === null || _2 === void 0 ? void 0 : _2.proration_amount) && (h("sc-line-item", { key: 'ec73eb49f952152ef4c00e40c3ac56d250c65124' }, h("span", { key: '1540e6365c07b918cc8b698349f7d0b8e4c1a215', slot: "description" }, wp.i18n.__('Proration', 'surecart')), h("span", { key: '4145ab74f11fc47b8f738ebdbba3b45a9f616045', slot: "price", style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            } }, (_3 = this.order) === null || _3 === void 0 ? void 0 : _3.proration_display_amount))), !!((_4 = this.order) === null || _4 === void 0 ? void 0 : _4.applied_balance_amount) && (h("sc-line-item", { key: 'ec30c49e9fc5d406b71a5b63a9d77253852406d4' }, h("span", { key: '5e6de9421f25501efd1861657200e9b1bbb45157', slot: "description" }, wp.i18n.__('Applied Balance', 'surecart')), h("span", { key: '4ce6d749ee86107a0a506c876cf556af5744c06c', style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            }, slot: "price" }, (_5 = this.order) === null || _5 === void 0 ? void 0 : _5.applied_balance_display_amount))), !!((_6 = this.order) === null || _6 === void 0 ? void 0 : _6.credited_balance_amount) && (h("sc-line-item", { key: '1f602620bbae03992dfc72ff3b0e6c8ee9549775' }, h("span", { key: '87d0cfa04a4c71a22e93a773007a335196bc3203', slot: "description" }, wp.i18n.__('Credited Balance', 'surecart')), h("span", { key: '9cbf2e9072834158ef8ab40d383e10fc7c6ab840', slot: "price", style: {
                'font-weight': 'var(--sc-font-weight-semibold)',
                'color': 'var(--sc-color-gray-800)',
            } }, (_7 = this.order) === null || _7 === void 0 ? void 0 : _7.credited_balance_display_amount))), ((_8 = this.order) === null || _8 === void 0 ? void 0 : _8.amount_due) !== ((_9 = this.order) === null || _9 === void 0 ? void 0 : _9.total_amount) && (h("sc-line-item", { key: '22c16ffabf3bf021c9547367773311053753241c', style: {
                'width': '100%',
                '--price-size': 'var(--sc-font-size-x-large)',
            } }, h("span", { key: 'dbf3f96253f5bdff9d070bfb92398798ddbc0723', slot: "title" }, wp.i18n.__('Amount Due', 'surecart')), h("span", { key: 'd5b09afb390a0b0c92c7e5f34f24f8d98c47c7d1', slot: "price" }, (_10 = this.order) === null || _10 === void 0 ? void 0 : _10.amount_due_display_amount), h("span", { key: 'd1a5e772da170608dab6d92b8cdbe0fd118dc067', slot: "currency" }, (_11 = this.order) === null || _11 === void 0 ? void 0 : _11.currency))), h("sc-divider", { key: 'd5a6c9e8b0dc1602ddeb06096d02a562c02d1617', style: { '--spacing': 'var(--sc-spacing-x-small)' } }), !!((_12 = this.order) === null || _12 === void 0 ? void 0 : _12.paid_amount) && (h("sc-line-item", { key: '3f77283d0336cc25bd0e22faa512a927fd378b90', style: {
                'width': '100%',
                '--price-size': 'var(--sc-font-size-x-large)',
            } }, h("span", { key: '51f735abe8a5219f0330c7dd7bfb66f51e517fcb', slot: "title" }, wp.i18n.__('Paid', 'surecart')), h("span", { key: '2d667f17951cdcc1d4f0d6d3cc76f1b813c9a622', slot: "price" }, (_13 = this.order) === null || _13 === void 0 ? void 0 : _13.paid_display_amount), h("span", { key: 'c5c42cd4f4a1f95af2e1627332ba13cc856a2fc2', slot: "currency" }, (_14 = this.order) === null || _14 === void 0 ? void 0 : _14.currency))), !!((_15 = this.order) === null || _15 === void 0 ? void 0 : _15.refunded_amount) && (h(Fragment, { key: '982ed7afdd0ca75d9d60a48a668060576de3cff9' }, h("sc-line-item", { key: '4ac1fc05e2acb32791acc9b72591b01c6b85a4cd', style: {
                'width': '100%',
                '--price-size': 'var(--sc-font-size-x-large)',
            } }, h("span", { key: '81d8c755b25042d1371374860886154faa32e04e', slot: "description" }, wp.i18n.__('Refunded', 'surecart')), h("span", { key: '1e34dc493441e97bfcd1585aa40b26bf9369447f', slot: "price" }, (_16 = this.order) === null || _16 === void 0 ? void 0 : _16.refunded_display_amount)), h("sc-line-item", { key: '9fea3f77a3d6f4631993b26bb1dbd8092e942440', style: {
                'width': '100%',
                '--price-size': 'var(--sc-font-size-x-large)',
            } }, h("span", { key: '15ce160d7b63585d012300abf8da3e8bda5ad946', slot: "title" }, wp.i18n.__('Net Payment', 'surecart')), h("span", { key: '59487504e0def2acaaa7e4fcf9757af7dfa5757d', slot: "price" }, (_17 = this.order) === null || _17 === void 0 ? void 0 : _17.net_paid_display_amount)))), ((_18 = this.order) === null || _18 === void 0 ? void 0 : _18.tax_reverse_charged_amount) > 0 && (h("sc-line-item", { key: '094bcd469599fea1191945f354fb0d0e99dc5175' }, h("span", { key: 'd08faa20a9fb417fefe0e1755e2320f951bc3429', slot: "description" }, wp.i18n.__('*Tax to be paid on reverse charge basis', 'surecart'))))));
    }
};
