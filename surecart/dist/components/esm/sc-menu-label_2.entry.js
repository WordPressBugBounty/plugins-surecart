import { r as registerInstance, h, c as createEvent, H as Host, a as getElement } from './index-25e5af33.js';
...
const ScMenuLabel = class {
    ...
    render() {
        return (h("div", { key: 'ce4a7e17c5db7a2b6e5384ab65b02c8a026fbeb3', part: "base", class: "menu-label" }, h("slot", { key: '18cedbaa9037aeca0d2ecf47594e1a0549e63b10' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b8b5f9d8782bfb28cefcc2e61f8bc7cf034484b1', tabindex: this.disabled ? -1 : 0, role: "button", "aria-haspopup": "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-label": accessibleName, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: 'ecb7d80fece771fc9fdc6d0a1e81d1dc163d11c0', part: "base", class: {
                'select': true,
            ...
            } }, h("sc-form-control", { key: 'cc578cf0eb3a72746385663f950f4a8601504e7f', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("input", { key: 'd3b2a53804975282433bab8d1be1bc291e227600', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), h("sc-dropdown", { key: '3c3950b0ee9480e72fdb8ddea013f1a715d7a8a1', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide() }, h("slot", { key: 'b57f7c83c66a6b1988a9b5db9f7dd84c882e9437', name: "trigger", slot: "trigger" }, h("div", { key: '617ca064cb675757217f163838434e82ca765554', class: "trigger", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: 'bb9686e43b62318128a6d0018a384201529241cd', class: "select__value" }, h("slot", { key: '8a3d1581fa20636d632d2c0c62b432f83fcaeb1c' }, displayValue)), h("sc-icon", { key: '843fa71c42928ad37c78ea83e919fc3522f622e7', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (h("sc-input", { key: '96ef0d65644e711d933118d60f9bd1c50fafb278', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && h("sc-spinner", { key: 'b735b03f84f9e8cd43c076ff7267b7864c8bf5a4', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), h("sc-menu", { key: '3a01afb3be1497188e2f115613d2dc6d90e95d20', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, h("slot", { key: '18a152d4f2025b45f175b6e612fc6e7668df1406', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (h("div", { key: '021eefa37cf08ceb1c92d41de13f50c137d1f7b9', class: "loading" }, h("sc-spinner", { key: 'a98d687f8491b9971510d4e1917b1f5c8cd09008', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (h("div", { key: 'd0eab4ad9dc101131aa5fe987b55764afa4eb320', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), h("slot", { key: 'fc143adeaf372f2fcf816bd0bf10c355479a596a', name: "suffix" })))))));
    }
