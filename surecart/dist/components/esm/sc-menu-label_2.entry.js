...
const ScSelectDropdown = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1322dca7c7bc4aaa59df5499276e1bfc3ac9e256', tabindex: this.disabled ? -1 : 0, role: "button", "aria-haspopup": "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-label": accessibleName, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: '690433d734499028c29c18812f4018c319f8c430', part: "base", class: {
                'select': true,
            ...
            } }, h("sc-form-control", { key: 'a0d0004cf7a58ead42f3cb7039919ca5ef6723e2', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("input", { key: 'fcd2f1196ff9b984c2323bf5a3d6848c958566a0', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), h("sc-dropdown", { key: 'aa5802fda760c0c8b78973229d86cf66549a1283', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide() }, h("slot", { key: 'd6773973ff2e7106f7a4dc5224915601f14fd47f', name: "trigger", slot: "trigger" }, h("div", { key: 'debc5668ad2be8c53e5bab6aa0525f6fbe5e26a4', class: "trigger", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: '6794d8bdfe40cd6f4c728fc361231f616c14257a', class: "select__value" }, h("slot", { key: '6ed8690daf375bdaac251f40474c4c686775343e' }, displayValue)), h("sc-icon", { key: '8056458a8d2cbf7a172a81826dd87539fc946c63', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (h("sc-input", { key: '2e223342901fe17a62971cd5560dfab023c2e7eb', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && h("sc-spinner", { key: 'ff9f0e58543be3fb6a0a8741c64e6b541baed82e', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), h("sc-menu", { key: '1b5557b2df51c9856ee3e4112883420b0d4b54d7', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, h("slot", { key: 'e21f0f74fa40cbe9adf9d1bf30c70ebfc90f6a5c', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (h("div", { key: '5a31cd0c9c7f219e6e7814edcdd3bbff17c68045', class: "loading" }, h("sc-spinner", { key: 'ab1fefd24c7406006ebb6399882bea837bdd8321', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (h("div", { key: '4f372f4a5e04dca82fdbb410bd2348aa1d890e7f', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), h("slot", { key: '6ab2f39af007889c3f42506aea0503ddc5c7a518', name: "suffix" })))))));
    }
