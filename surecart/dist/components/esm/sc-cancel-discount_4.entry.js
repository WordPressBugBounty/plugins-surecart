...
const ScCancelDiscount = class {
    ...
    render() {
        ...
        return (h("div", { key: '9f59df3d0f90de8ba7eaeb8628b461373a705a33', class: "cancel-discount" }, h("sc-dashboard-module", { key: '2a6c6b8bc993076addc5dee0eef35936dac1e62c', heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, h("span", { key: 'ecc1c0107cc9112cb8c8a164d82465745e410752', slot: "description" }, description), h("sc-flex", { key: '64537ad476b2298887f21e6dc4ba2e08a9ec6ef0', justifyContent: "flex-start" }, h("sc-button", { key: '1f50fd1c2427a087a70e67d44b99213f9d48ccfe', type: "primary", onClick: () => this.addDiscount() }, button), h("sc-button", { key: 'eb077b78799790804ade49512b25faad74a95527', class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && h("sc-block-ui", { key: '1e4bfd88fb8bf62eca861f2d87e7d7fe9817502e', spinner: true }))));
    }
};
...
const ScSubscriptionCancel = class {
    ...
    render() {
        ...
        return (h("sc-dashboard-module", { key: '31ce702c188f88a3057d63a6b21da47b96d4a730', heading: heading, class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, h("div", { key: 'b05ca7bd77b88ee2dbe1d4a85911fb011d4fb170', slot: "description" }, content, h("slot", { key: '04110f6cdac7368dc90ed29ac2d3d758792e7b93', name: "cancel-popup-content" })), h("sc-flex", { key: '79f8db543976f6a53cecdfa3ce6c739fc132795b', justifyContent: "flex-start" }, h("sc-button", { key: '0925b9cdad5a700f6260895e691fcad9257eb337', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, cancelButtonText), h("sc-button", { key: '4f949eeb36127878ad1054e71cc5c8b2fad6c512', type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, keepButtonText)), this.busy && h("sc-block-ui", { key: '5cd6f8e97485aad07d363a2f285729e3d308b7fb' })));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        var _a;
        return (h("div", { key: '4614991f620c3c829b41154da0ecf969d046f104', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, h("sc-form-control", { key: 'b5f43904835c5c6356ce76f48572334dbef524b1', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: '484aec87df908658e335d19d42e03a324bb96e64', part: "form-control-input", class: "form-control-input" }, h("div", { key: 'a13700d3efbdc13e2f9e4ccfa20111c3a0afc30d', part: "base", class: {
                'textarea': true,
