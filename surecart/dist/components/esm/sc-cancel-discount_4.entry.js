...
const ScCancelDiscount = class {
    ...
    render() {
        ...
        return (h("div", { key: '46f052bd78ac871b183bb1171f5283208ad15eae', class: "cancel-discount" }, h("sc-dashboard-module", { key: '5a813d71276b9bd4e8c125b22ec79fe4b1f04687', heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, h("span", { key: '60a042d799f892adc0f26251f73009bcac0951a4', slot: "description" }, description), h("sc-flex", { key: '4de51679d747382d8ef982d9cd09da337f5e688e', justifyContent: "flex-start" }, h("sc-button", { key: '7527eeda6ce74842418b7e582a80b51084f24a18', type: "primary", onClick: () => this.addDiscount() }, button), h("sc-button", { key: 'a906bd74740a557316b5b318de36a0aebded4c4a', class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && h("sc-block-ui", { key: 'dde4ac0fa769fa31144d78f32c8e317fd8f926dc', spinner: true }))));
    }
};
...
const ScSubscriptionCancel = class {
    ...
    render() {
        ...
        return (h("sc-dashboard-module", { key: '04497caed27e3ae8162f3b64dd2ce000dd26043b', heading: heading, class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, h("div", { key: 'f7caf8ae8c663c62e99f993602ae4b7f576598cc', slot: "description" }, content, h("slot", { key: '7d1dcabe5dde6482ba1253c5d3c943c739c13a0e', name: "cancel-popup-content" })), h("sc-flex", { key: '67d82211ec0d1c7c2a849155ef4a02b855048aa5', justifyContent: "flex-start" }, h("sc-button", { key: '8aa72049de6b7401b886b1335d6d434cab132505', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, cancelButtonText), h("sc-button", { key: '392b704107b68aa85881bf2545b59681b14c2fff', type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, keepButtonText)), this.busy && h("sc-block-ui", { key: '14110715787c6564b1d48cfdc507e8a57f34102b' })));
    }
};
