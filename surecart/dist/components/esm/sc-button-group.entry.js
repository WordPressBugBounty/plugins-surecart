...
const ScButtonGroup = class {
    ...
    render() {
        return (h("sc-form-control", { key: '0dc0bfcb4fcfd8fc16ad90c20b720aa29dc0bb80', part: "base", class: {
                'button-group': true,
                'button-group--separate': this.separate,
            }, role: "group", "aria-label": this.label, onFocusout: e => this.handleBlur(e), onFocusin: e => this.handleFocus(e), onMouseOver: e => this.handleMouseOver(e), onMouseOut: e => this.handleMouseOut(e), label: this.label }, h("slot", { key: '9a5950095e29ed8be62268b8a2685e385df93e0f', onSlotchange: () => this.handleSlotChange() })));
    }
