...
const ScDialog = class {
    ...
    render() {
        return (h("div", { key: '4f1101053eff617381da2f147fa59f71cc3dcf94', part: "base", ref: el => (this.dialog = el), class: {
                'dialog': true,
                'dialog--open': this.open,
                'dialog--has-footer': this.hasFooter,
            }, onKeyDown: e => this.handleKeyDown(e) }, h("div", { key: 'a4f9a65523583442ab2e0684176cc2690ec2c163', part: "overlay", class: "dialog__overlay", onClick: e => {
                e.preventDefault();
                e.stopImmediatePropagation();
                this.requestClose('overlay');
            }, ref: el => (this.overlay = el), tabindex: "-1" }), h("div", { key: 'c92b32fb88f78996c1abb2f28e942d535c8463b0', part: "panel", class: "dialog__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader || this.label, "aria-labelledby": !this.noHeader || 'title', ref: el => (this.panel = el), tabindex: "0" }, !this.noHeader && (h("header", { key: 'd1268e9d7893c4a080badbffef89db43cc5e0f5f', part: "header", class: "dialog__header" }, h("h2", { key: '19b13e3a4ba16857bb814cab19a5c861dca59ceb', part: "title", class: "dialog__title", id: "title" }, h("slot", { key: '2b61e770a038978401ab7054f38a7f674a0f39f4', name: "label" }, " ", this.label.length > 0 ? this.label : String.fromCharCode(65279), " ")), h("sc-button", { key: 'a5a8f2dcb5cad6ef40a0bb5a60c4638b92e0a709', class: "dialog__close", type: "text", circle: true, part: "close-button", exportparts: "base:close-button__base", onClick: e => {
                e.preventDefault();
                e.stopImmediatePropagation();
                this.requestClose('close-button');
            } }, h("sc-icon", { key: 'ee421e3f2f21a1363ff63085038db3ea9b5a0806', name: "x", label: wp.i18n.__('Close', 'surecart') })))), h("div", { key: '1c22da3b6e6a08f5f6d734e36267c196b85bc8a9', part: "body", class: "dialog__body" }, h("slot", { key: 'b97bb7b76d4604e625fb0fd372ccad4ed7e6f8ac' })), h("footer", { key: 'cb149622bb5a5d565dd8fd86d18159171a10638a', part: "footer", class: "dialog__footer" }, h("slot", { key: '1bac6e872070a8a1d5f9fc9fb3c62ea9299a08cd', name: "footer" })))));
    }
