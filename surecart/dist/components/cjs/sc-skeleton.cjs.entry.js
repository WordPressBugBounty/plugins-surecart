...
const ScSkeleton = class {
    ...
    render() {
        return (index.h("div", { key: '82efda2e3bab6f36a85d1194862d37d0907ce803', part: "base", class: {
                'skeleton': true,
                'skeleton--pulse': this.effect === 'pulse',
                'skeleton--sheen': this.effect === 'sheen',
            }, "aria-busy": "true", "aria-live": "polite" }, index.h("div", { key: 'efa0d994bd8e9afb95905031e79868f6c187acfe', part: "indicator", class: "skeleton__indicator" })));
    }
};
