...
const ScProductItem = class {
    ...
    render() {
        ...
        return (index.h("a", { key: '431c643cac05b4eee23dc1402a99721a4035af47', href: (_a = this.product) === null || _a === void 0 ? void 0 : _a.permalink, class: { 'product-item': true } }, this.product &&
