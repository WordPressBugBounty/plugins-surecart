...
const ScPopover = class {
    ...
    render() {
        return (index.h("div", { key: 'cce921602076d67e1c0da05ea773c537437159ee', part: "base", class: {
                'popover': true,
                'popover--open': this.open,
                'popover--disabled': this.disabled,
            } }, index.h("span", { key: '6e62d815870e8856b621f02408ec0bcc31bce0dc', part: "trigger", class: "popover__trigger", ref: el => (this.trigger = el), onClick: () => {
                if (this.disabled)
                    return;
                if (this.open) {
                    this.hide();
            ...
            }, onKeyDown: e => this.handleTriggerKeyDown(e), tabindex: "0", role: "button", "aria-expanded": this.open ? 'true' : 'false', "aria-haspopup": "dialog", "aria-label": wp.i18n.__('Press Enter to open popover', 'surecart') }, index.h("slot", { key: '86fbfd165eb809c2d6496a53f5710321a468d79d', name: "trigger" })), index.h("div", { key: '3d5dead654e5b53b847c4930fd115197dc213e2a', class: "popover__positioner", ref: el => (this.positioner = el) }, index.h("div", { key: '0e9728f44c082c2104614630e97a9b758edc06b4', part: "panel", class: "popover__panel", role: "dialog", "aria-modal": "false", tabindex: "-1", ref: el => (this.panel = el) }, index.h("div", { key: '0d91b7bd925daeaadd324d87b7a39579d3c13a86', class: "popover__header" }, index.h("slot", { key: 'e60261e2f551d330cf68e0386a4509965192b9ac', name: "title" }), index.h("button", { key: 'caf0be2cbd79155ffa77d82cb4d8ce9e0e071926', type: "button", class: "popover__header-close-button", onClick: () => this.handleHide(), onKeyDown: e => e.key === 'Enter' && this.handleHide(), "aria-label": wp.i18n.__('Close', 'surecart') }, index.h("sc-icon", { key: 'e2cf1084c7f1fe9d072b7d20559d1d07a70e8561', class: "popover__header-close-icon", name: "x" }))), index.h("slot", { key: '11dfab5a6f42ee96036084e73bb3266385839508', name: "content" }), index.h("div", { key: '81f3b12f62118fcfbe4a0c5827f9f777c47ba556', class: "popover__footer" }, index.h("slot", { key: 'c51b7adb11cecdd6b963b0dc2f521d599f59db9f', name: "footer" }))))));
    }
