...
const ScLogin = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: 'c7b4d3e7d4604b71ffac7cfdaffec01ae6627f65', class: "login-form" }, index.h("sc-card", { key: 'a8e82ca9c59f80dec0d30ffe7a5246ab4017d126' }, !!this.error && (index.h("sc-alert", { key: '07cb7e63e945537cc95653d45344b599a544ff4c', open: true, type: "danger", closable: true, onScHide: () => (this.error = null) }, index.h("span", { key: 'b54daf24aca427beae344c5cbfcac876eb441fc2', slot: "title", innerHTML: (_a = this.error) === null || _a === void 0 ? void 0 : _a.message }), (((_b = this.error) === null || _b === void 0 ? void 0 : _b.additional_errors) || []).map(({ message }) => (index.h("div", { innerHTML: message }))))), this.renderInner()), this.loading && index.h("sc-block-ui", { key: '8d9f377acf76a7a208392407489b3cc370e42684', spinner: true, style: { 'zIndex': '9', '--sc-block-ui-opacity': '0.5' } })));
    }
