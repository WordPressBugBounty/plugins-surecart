...
const ScMenuLabel = class {
    ...
    render() {
        return (index.h("div", { key: 'a1c467629837cec4af00eec6f909dc0eb5deb6f3', part: "base", class: "menu-label" }, index.h("slot", { key: '71803fcb58b2258f6c388972587e3a159b462ed2' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ef2b7f2e21df35650496eddff5518ed6059ced01', tabindex: this.disabled ? -1 : 0, role: "button", "aria-haspopup": "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-label": accessibleName, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: 'f5f288527cd2fc00394352f3306afbbe7a5913d1', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: '7e361c1a3f052bb400e5df42e188ca7243328215', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '7a14f599dff575cbade11fae447f403361b9e146', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), index.h("sc-dropdown", { key: 'c658cfe6bec8830c809482842eacbf294c461bf4', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide() }, index.h("slot", { key: 'c7b2c621a87c4432f923de03d1b30bdf77face61', name: "trigger", slot: "trigger" }, index.h("div", { key: '88987679157d5672e9733bb10a65b9d76e4f05c0', class: "trigger", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: '54166076a8164c2d22ba3c6e3aeada7878b2ffe6', class: "select__value" }, index.h("slot", { key: '33cf71c3a6cfadd32f958a2eea9a18330ee14aba' }, displayValue)), index.h("sc-icon", { key: 'b1dee023669ab233b1c070da8c63423fad0929f2', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: '904e01e500c0b0efec434196fca12c5dda87427d', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: '2d57da88811c1f1a74c806ce99d7238914c69f21', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: 'eb007372b14b4ad8080d526017b369537ce48e31', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: 'fd5c5474f310aa59320832aeeb6b69269667ca37', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: '778e0740fdd3e4eb623203f84668a918aa27f65e', class: "loading" }, index.h("sc-spinner", { key: 'a150dc6aefe4f545025c2b2477c33a402f6a3448', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: 'ab5fda1cb1594ecdc3517f35b534b94c268cef20', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: '9aafa05091f6ae32495e99bd93566a670454af98', name: "suffix" })))))));
    }
