...
const ScSelectDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f5c2b4e6054a3f5c1dc25eab134203c0232c1245', tabindex: this.disabled ? -1 : 0, role: "button", "aria-haspopup": "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-label": accessibleName, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: 'ed87e9df4a76e0acad7d26ac1f8d50b2364f0bb0', part: "base", class: {
            ...
            } }, index.h("sc-form-control", { key: '21829cb983809e45971f317fe683054a3ada8619', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '49f2997a133326940f823aad648e6b74fc96e9b0', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), index.h("sc-dropdown", { key: '5b98ceb3e02acaac6da8668a5161a45101f2c632', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide() }, index.h("slot", { key: '31100b7612e6549e1313d99a3b17d07e677e633b', name: "trigger", slot: "trigger" }, index.h("div", { key: '192b83bce571763bf9262bfaca8481b897ca16d5', class: "trigger", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: 'e25dac1130e6fc4b97ff5f5ffe771284bae4b3d4', class: "select__value" }, index.h("slot", { key: '7fc572a7ae905b055bf5bd3a38d75eb72aceeb4d' }, displayValue)), index.h("sc-icon", { key: '1be08331b746cd38aadfae2ce383d821f5bffb99', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: '9a37431d28b53a49f746dcc743641c38767e38ea', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: 'c049b4285ef1181221269e3faa80618c280ce5f9', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: '1c3cabc783d0df24060dae595413aef33dbdd765', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: '048eff7fd28433abf0a21f3b5885381c373f948f', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: '009793301642d87c9e8e2849b69dc16c53f533ad', class: "loading" }, index.h("sc-spinner", { key: 'fbc2bd09b9635d84664987d1668fb8d4376a8cfb', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: '2223323ebd757f49dc8ec8ebc5b538b1b5526a4b', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: '8730a4b45a5105837718d9b4341a77b5a330cf4d', name: "suffix" })))))));
    }
