...
const ScUpsellNoThanksButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '80f1805f2768c82177f6d7e9a29f3e8310783f79', onClick: () => mutations.decline() }, index.h("slot", { key: '2369d436e4651a28b0a2da3c4eda4caa5feb392f' })));
    }
};
