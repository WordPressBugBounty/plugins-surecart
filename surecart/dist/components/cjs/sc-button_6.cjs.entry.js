...
const ScProductLineItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '83d9573f96517b1e5589f6ed917e1232d52f44e6', class: "base", part: "base" }, index.h("div", { key: '1a9fc5b3065201292ca576c542906c69716383c6', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_d = this.image) === null || _d === void 0 ? void 0 : _d.src) ? (index.h("img", { ...this.image, part: isImageFallback ? 'placeholder__image' : 'image', class: isImageFallback ? 'item__image-placeholder' : 'item__image' })) : (index.h("div", { class: "item__image-placeholder", part: "placeholder__image" })), index.h("div", { key: '46e4e94c95be8949922be91eabd354324445820c', class: "item__text-container" }, index.h("div", { key: '8a092d0b25ed8f08feea9f4d5d2283bcb4a88017', class: "item__row" }, index.h("div", { key: '99f2a5b72d749bac8fb169a2d0424340b7baa777', class: "item__title", part: "title" }, index.h("slot", { key: '6b5a077ca5acced18163ff6f0b3ad66cb9129b7e', name: "title" }, this.name), bundleCount > 0 && (index.h("span", { key: '3a310ffe710600c73e59905789864a1f762b0d03', class: "item__title-count", "aria-hidden": "true" }, "(", bundleCount, ")")), bundleCount > 0 && index.h("span", { key: 'afd855d2f64476c6a02f52181303f0febd1aa3f7', class: "visually-hidden" }, wp.i18n.sprintf(wp.i18n._n('Includes %d item', 'Includes %d items', bundleCount, 'surecart'), bundleCount))), index.h("div", { key: 'a4a0b90d1faaf3b9bd4b303bc71f1cdfffe77911', class: "price", part: "price__amount" }, !!this.scratch && this.scratch !== this.amount && index.h("span", { key: '742fa88c625a4388bb556b8ee32fed9eefd8f630', class: "item__scratch-price" }, this.scratch), this.amount, index.h("div", { key: 'a4c7b0d1852a0ea3d1e17458c70c017cef2b43bb', class: "price__description", part: "price__description" }, this.interval))), hasMetaRow && (index.h("div", { key: 'b5aabb2e2d0cc5fd936656124336b05f99cf0100', class: "item__row" }, index.h("div", { key: 'f6f152b2ddcba92b6c8d2ecda0f49e4c8b8dd6ed', class: "item__description", part: "description" }, this.variant && index.h("div", { key: 'd499b9a0390314f3f7fde5b876d4a2946d59bd6a' }, this.variant), this.price && index.h("div", { key: '12394beab31dd51be37c885b7c023159c312ebf8' }, this.price), this.sku && (index.h("div", { key: '7f57930476202c91a6b360beb72996f0fa940fe1' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku)), !!this.purchasableStatus && index.h("div", { key: 'e69060d0491f81ac9825b5c29c6c0c58114756ad' }, this.purchasableStatus)), index.h("div", { key: '20d21e071cbedd6e9832c28e1654ae6ed0535d3e', class: "item__description", part: "trial-fees" }, !!this.trial && index.h("div", { key: '8bb86047207a23fd3327943b8e0eeec018b3f93b' }, this.trial), (this.fees || []).map(fee => {
            return (index.h("div", null, fee === null || fee === void 0 ? void 0 :
                fee.display_amount, " ", fee === null || fee === void 0 ? void 0 :
                fee.description));
        })))), this.renderDetails(), !!this.note && (index.h("div", { key: '43e4128b6f44b4eb9f118f00a32fdbe2fdc65857', class: "item__description" }, index.h("sc-product-line-item-note", { key: '4a94e30b0530426c99df5faeb5195385c3f628aa', note: this.note, exportparts: "base:note" }))), index.h("div", { key: 'a0629cdd7906c2eebe12b3457eeac878842565ed', class: "item__row stick-bottom" }, this.editable ? (index.h("sc-quantity-select", { max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.price), productName: this.name })) : (index.h("span", { class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity)), !!this.reviewButtonLink && (index.h("div", { key: '3cc3d05585054334d3995e440de0a0523184ce34', class: "item__add-review" }, index.h("sc-button", { key: 'c26a69bfd4605193113a240b4fa33bd6c69eed21', size: "small", href: this.reviewButtonLink, target: "_blank" }, wp.i18n.__('Review Product', 'surecart')))), !!this.removable && (index.h("div", { key: 'ea6d312c2ec917b332c30ab46128b74f37b37f43', class: "item__remove-container", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
            }, "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %1$s %2$s', 'surecart'), this.name, this.amount), tabIndex: 0 }, index.h("sc-icon", { key: 'b0b99a1488432d4b6577322b912a3dc5246fc170', exportparts: "base:remove-icon__base", class: "item__remove", name: "x" }), index.h("span", { key: 'ba58e3c57316d646ad85cf2de19fb61008076704', class: "item__remove-text" }, wp.i18n.__('Remove', 'surecart')))))))));
    }
...
const ScQuantitySelect = class {
    ...
    render() {
        return (index.h("div", { key: 'f87d0e717cca0f093b8cd46001668ee45acd602e', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, index.h("button", { key: 'b87e536709d9facd789600480e15e491ed8f59e4', part: "minus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Decrease %1$s quantity by one', 'surecart'), this.productName), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, index.h("sc-icon", { key: '587cea8b0c6b06b0ddee6b88dd610f3363066f0a', name: "minus", exportparts: "base:minus__icon" })), index.h("input", { key: 'ab04a8b9dde3ce3960f4d5f83d5902fc692a1815', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Quantity input for %1$s product', 'surecart'), this.productName) }), index.h("button", { key: '969d9da1d6cac9d9aa484b1a3b1983f0325c65fb', part: "plus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Increase %1$s quantity by one', 'surecart'), this.productName), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, index.h("sc-icon", { key: '498ee6e4edac91ab06c2f13fe8b4df553b98a34a', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return index.getElement(this); }
};
...
const ScSpinner = class {
    ...
    render() {
        return index.h("span", { key: '2ee97812cfb75bbdc7b60de3552494267e4480ac', part: "base", class: "spinner", "aria-busy": "true", "aria-live": "polite" });
    }
};
