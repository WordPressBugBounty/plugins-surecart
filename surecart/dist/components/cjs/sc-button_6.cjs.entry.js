...
const ScButton = class {
    ...
    render() {
        ...
        const interior = (index.h(index.Fragment, { key: 'a215c69c501a67070b8134275fe4c04f63a1b766' }, index.h("span", { key: '14f2d8660fa655687640c1f4da89bca154c4a045', part: "prefix", class: "button__prefix" }, index.h("slot", { key: '70324c9b16e7aebf17afec217ef231dfb0a14cf5', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), index.h("span", { key: 'c40bd504722c7f62ad4a5f0c4f89cbf265e22d4d', part: "label", class: "button__label" }, index.h("slot", { key: 'e6f368e35f244f8d940bbef3fd93d6cd8605eba8', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: 'b0e539bd93828a9e18754ccc2e596e5616d6c3d2', part: "suffix", class: "button__suffix" }, index.h("slot", { key: 'f10fdf286612e3675a054482f5e56cae5fa9ef48', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), this.caret ? (index.h("span", { part: "caret", class: "button__caret" }, index.h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("polyline", { points: "6 9 12 15 18 9" })))) : (''), this.loading || this.busy ? index.h("sc-spinner", { exportparts: "base:spinner" }) : ''));
        return (index.h(Tag, { key: 'ce822406954016315c1d9c0722bdce0bd3ffd5a7', part: "base", class: {
                'button': true,
...
const ScIcon = class {
    ...
    render() {
        return index.h("div", { key: '1d23f7f715fffdd7de869a74f9fad1e70c6f407b', part: "base", class: "icon", role: "img", "aria-label": this.getLabel(), innerHTML: this.svg });
    }
...
const ScProductLineItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '93f98a7753094942de4387450eea0fb384f9f0ed', class: "base", part: "base" }, index.h("div", { key: '8a66cd703dc288922194403ed7c3320f4f11c565', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_c = this.image) === null || _c === void 0 ? void 0 : _c.src) ? (index.h("img", { ...this.image, part: isImageFallback ? 'placeholder__image' : 'image', class: isImageFallback ? 'item__image-placeholder' : 'item__image' })) : (index.h("div", { class: "item__image-placeholder", part: "placeholder__image" })), index.h("div", { key: '46ba64b44a728e1086431e396e1a7eb058e8c541', class: "item__text-container" }, index.h("div", { key: '3ca6b3e0f81fc7d157a76c4ca82636d4fabcf940', class: "item__row" }, index.h("div", { key: '1b73c9473d0227dd38186534eb0d17520ddb6b6e', class: "item__title", part: "title" }, index.h("slot", { key: 'edffd6a363a6e42aa71f4daf03a9c85cbc31e198', name: "title" }, this.name)), index.h("div", { key: 'ec0e5336bde9dcef015746350e46b744cabd9ef8', class: "price", part: "price__amount" }, !!this.scratch && this.scratch !== this.amount && index.h("span", { key: '8ac8b6371b85ae3a95f2a567cf4456d4700d2b98', class: "item__scratch-price" }, this.scratch), this.amount, index.h("div", { key: 'c1411be20950c10620e949041d4773a3cebd1f7f', class: "price__description", part: "price__description" }, this.interval))), index.h("div", { key: '9de7bdea73947bec916705a31809c0d60f651361', class: "item__row" }, index.h("div", { key: '77de488554dd942ed3f1eefd9ba95f833ee6991f', class: "item__description", part: "description" }, this.variant && index.h("div", { key: '47cb94a056d9256e246caa2fdbcc0fe256424537' }, this.variant), this.price && index.h("div", { key: '45ae9363e8a2e7cb10aee854029b1c84ee7fee2b' }, this.price), this.sku && (index.h("div", { key: '9418f991f80432adb12949461ea9e03533762977' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku)), !!this.purchasableStatus && index.h("div", { key: '61831c69b0287662df9fd8c2653167ead38d592d' }, this.purchasableStatus), !!this.note && index.h("sc-product-line-item-note", { key: '27a62cbc9e463726032a88991ed953beeea8ca51', note: this.note })), index.h("div", { key: 'abae4e2eb4d52bbff723ed3bb9433b8a0187ea4a', class: "item__description", part: "trial-fees" }, !!this.trial && index.h("div", { key: 'f1abd62dfb4b962bee534c9c51805236f1b258fc' }, this.trial), (this.fees || []).map(fee => {
            return (index.h("div", null, fee === null || fee === void 0 ? void 0 :
                fee.display_amount, " ", fee === null || fee === void 0 ? void 0 :
                fee.description));
        }))), index.h("div", { key: 'd96847e4671aaaaea10a82d1500f888f53fcfdcd', class: "item__row stick-bottom" }, this.editable ? (index.h("sc-quantity-select", { max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.price), productName: this.name })) : (index.h("span", { class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity)), !!this.reviewButtonLink && (index.h("div", { key: 'de906087ec0e04a16fe5ae04f1e3f5eff8904e03', class: "item__add-review" }, index.h("sc-button", { key: '79d8fea7795cd326f1da7e19f487c2faf32a69c5', size: "small", href: this.reviewButtonLink, target: "_blank" }, wp.i18n.__('Review Product', 'surecart')))), !!this.removable && (index.h("div", { key: 'e62351437749abfada3384395af035f377d26f51', class: "item__remove-container", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
            }, "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %1$s %2$s', 'surecart'), this.name, this.amount), tabIndex: 0 }, index.h("sc-icon", { key: '0b4eab9c3d117e8e0165e7209d1092513d459d0f', exportparts: "base:remove-icon__base", class: "item__remove", name: "x" }), index.h("span", { key: 'a8c209d2ea2d30d10b7f74a34c8d7ca48bba4485', class: "item__remove-text" }, wp.i18n.__('Remove', 'surecart')))))))));
    }
...
const ScQuantitySelect = class {
    ...
    render() {
        return (index.h("div", { key: 'dd980cf2280eb7649eac9f593d967aef6b2f799a', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, index.h("button", { key: '95112a89bebeaecd449ec44d70fce3063d1faee6', part: "minus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Decrease %1$s quantity by one', 'surecart'), this.productName), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, index.h("sc-icon", { key: '731c1c8cd8afd3a8f863f04ee8634f096da62922', name: "minus", exportparts: "base:minus__icon" })), index.h("input", { key: 'cdf6af99f13594e26010e24ab3a4610c07cd77bc', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Quantity input for %1$s product', 'surecart'), this.productName) }), index.h("button", { key: 'e7b1b1e1a41b6941d58119ae720cc3358453e153', part: "plus", "aria-label": 
            /** translators: %1$s: product name */
            wp.i18n.sprintf(wp.i18n.__('Increase %1$s quantity by one', 'surecart'), this.productName), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, index.h("sc-icon", { key: 'b9fb517dbe592c6bfb22464363f99f2e32306b7a', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return index.getElement(this); }
};
...
const ScSpinner = class {
    ...
    render() {
        return index.h("span", { key: '939d062fbb561d67bc0426348a24f5b51797e841', part: "base", class: "spinner", "aria-busy": "true", "aria-live": "polite" });
    }
};
