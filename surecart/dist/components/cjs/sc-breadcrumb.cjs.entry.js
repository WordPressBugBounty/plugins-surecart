...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'eb9c9816fbb4d555dbf709693fc6391e98c6cdfe', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, index.h("span", { key: 'ccba39991c8ff95d4f8626a4f2471a235415cf8e', part: "prefix", class: "breadcrumb-item__prefix" }, index.h("slot", { key: 'c46fa6ca7d90fbbaf39b9c89c803f910f5c1afd0', name: "prefix" })), index.h(Tag, { key: '7522e0101f41e842c0c9494957639f8512713e31', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, index.h("slot", { key: 'd8b68abd8ec13cc1e37eed0b4e636bfa9943898d' })), index.h("span", { key: '11ee533f721994e98b93d5d90f32610166801f5b', part: "suffix", class: "breadcrumb-item__suffix" }, index.h("slot", { key: '8c2dcfb91fcdb6d641d0c8fcaa8437ad4db83a67', name: "suffix", onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: 'ef808b0c5ccebc7fc002b864b1642afaafcb7898', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, index.h("slot", { key: '818ea7635b43ce285429b0f76969c35c84ffe5e0', name: "separator", onSlotchange: () => this.handleSlotChange() }, index.h("sc-icon", { key: '45924ed274e7468a1b3f17c36f7936c64a581da7', name: "chevron-right" })))));
    }
