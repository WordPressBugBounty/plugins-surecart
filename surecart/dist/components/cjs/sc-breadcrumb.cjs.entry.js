...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7e35ecbc546aa8e1c06d47179c39592b6e0a9d6f', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, index.h("span", { key: 'f2a57f47e76c6ee95f54ef68213f74c48f69e3f5', part: "prefix", class: "breadcrumb-item__prefix" }, index.h("slot", { key: 'ee35d51ef3f1f7d66a23069f0599a1c9341756d2', name: "prefix" })), index.h(Tag, { key: 'a26c0e8063203ca7843abe56d918248ba86734d2', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, index.h("slot", { key: '3f0d0d69f539480ef3982fda373a45c80c55be21' })), index.h("span", { key: '5e94145a45aca4fac435b3def82920513d14a4a8', part: "suffix", class: "breadcrumb-item__suffix" }, index.h("slot", { key: 'a8f4c8c80a1099c434aa9d86e163ac7786fb8fa1', name: "suffix", onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '694f9760ad9d5a0f4cea30799700151f9e4207ec', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, index.h("slot", { key: 'ee31aa07be708fc79cec6e560cad576a686ae46d', name: "separator", onSlotchange: () => this.handleSlotChange() }, index.h("sc-icon", { key: 'd3fdeb1a37d34cbdd20a14aa89957181f2da3eb6', name: "chevron-right" })))));
    }
