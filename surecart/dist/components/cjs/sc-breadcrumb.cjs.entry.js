...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ebb2d700bf01b12e546c7a21acd30410765566a0', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, index.h("span", { key: '0a70f8a25bb09a1f467324b1cda3cc508fc97844', part: "prefix", class: "breadcrumb-item__prefix" }, index.h("slot", { key: 'cd791064d8e889325647cbe79960bc8868c942fb', name: "prefix" })), index.h(Tag, { key: '0b75c42b4c20a5aa11c238ac8f4ad0348b865082', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, index.h("slot", { key: '256faeca24aabb6f316b8364fcc6aaa60e77e689' })), index.h("span", { key: 'b2ccf49ffdf39317a3ca3161522e31c399a72781', part: "suffix", class: "breadcrumb-item__suffix" }, index.h("slot", { key: '60281f60d4d1df5f75f66d41420be42482434765', name: "suffix", onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '73eb7def97b684a6656604a864ecf2780bf99050', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, index.h("slot", { key: '44feaf41820876fdfd3604ac1c1bff27ff05ae67', name: "separator", onSlotchange: () => this.handleSlotChange() }, index.h("sc-icon", { key: '5864502c527fa124cea49fc0406c1da7e4e0c15e', name: "chevron-right" })))));
    }
