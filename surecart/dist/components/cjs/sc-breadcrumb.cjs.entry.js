...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'aa7d27608e2c8a261fc16e93ba30d29be1e940fa', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, index.h("span", { key: 'd3acb541f4ad03ad2c05ff1055d7b50c939a0c65', part: "prefix", class: "breadcrumb-item__prefix" }, index.h("slot", { key: '9511e5c62a62a459b304bd04c3bd6a2ac8beff3d', name: "prefix" })), index.h(Tag, { key: '87b58f93291ef70118f841c59c914cb4c7718dfa', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, index.h("slot", { key: 'c098ee4f5d3ae2505269facbcfb8a16607e49ed3' })), index.h("span", { key: '806498ae36575f1dd55ed0b260bfa4c3c469f53b', part: "suffix", class: "breadcrumb-item__suffix" }, index.h("slot", { key: '644088c3e4a811df41cf1c1756278da444c24ec2', name: "suffix", onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '581cba5cafbfb07e135dfa6d072e4a46076f85f6', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, index.h("slot", { key: '25c23f009e8b0accd44900303be754c4976471aa', name: "separator", onSlotchange: () => this.handleSlotChange() }, index.h("sc-icon", { key: '96afb354c792816f2672de7811cddaf2269d4fc2', name: "chevron-right" })))));
    }
