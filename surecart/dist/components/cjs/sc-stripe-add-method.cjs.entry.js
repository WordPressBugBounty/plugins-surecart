...
const ScStripeAddMethod = class {
    ...
    render() {
        return (index.h("sc-form", { key: '4e01e08417fcf9fc03a8bbfae6d37820cd02f100', onScFormSubmit: e => this.handleSubmit(e) }, this.error && (index.h("sc-alert", { key: 'e3fa40fcaf9bf7dad482c173f56d1988c2a1e3a3', open: !!this.error, type: "danger" }, index.h("span", { key: 'f00e2838bee0e7bada741582c226138b3d6f98ea', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: '10d92e94c031a3b461a62e85a45ce1319a50c2b3', class: "loader", hidden: this.loaded }, index.h("div", { key: '611188c402718eb677aecd542c94cd24ee6cd2ee', class: "loader__row" }, index.h("div", { key: 'b7ef6295d36c731acebd54c2362aece60e31070f', style: { width: '50%' } }, index.h("sc-skeleton", { key: '273535244b582b9abb9b755779f039833f880dab', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '3185f71444908fb9a76962e8fc5c7b93e73a0ac7' })), index.h("div", { key: 'aeb7db03f2973a161c618ad90ad42e300b3ad465', style: { flex: '1' } }, index.h("sc-skeleton", { key: '199782eae2098b3bdc5da92fe127d4f09dded47b', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '30eb47923704b6459efa648375b58ed86acc1698' })), index.h("div", { key: '7783c5b204d5339c79c812f534e6014eef2cebdf', style: { flex: '1' } }, index.h("sc-skeleton", { key: 'de69dc68ebaaf17aaf90375062d1dee623067020', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '3fb3ac449848d63d5b1d27df0dfda50abda00cb5' }))), index.h("div", { key: '591bd157598f3794d907bf279c59fa5b93ffb72f', class: "loader__details" }, index.h("sc-skeleton", { key: 'cfa1052c5c626668401ca8e5f18fb286d3f03800', style: { height: '1rem' } }), index.h("sc-skeleton", { key: 'b24a28d7e118e5ce919ead0031da3584124cb208', style: { height: '1rem', width: '30%' } }))), index.h("div", { key: '84b81f5a6d9acd51e770b0295da8734bc5888c3b', hidden: !this.loaded, class: "sc-payment-element-container", ref: el => (this.container = el) }), index.h("sc-button", { key: '59f93a9cd4c61eaa9d83f8dd447f811f813f7562', type: "primary", submit: true, full: true, loading: this.loading }, wp.i18n.__('Save Payment Method', 'surecart'))));
    }
