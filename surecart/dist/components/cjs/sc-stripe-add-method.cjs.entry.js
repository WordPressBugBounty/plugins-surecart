...
const ScStripeAddMethod = class {
    ...
    render() {
        return (index.h("sc-form", { key: '0e565d01fad67dd52a588cacae38b4baf10bdedd', onScFormSubmit: e => this.handleSubmit(e) }, this.error && (index.h("sc-alert", { key: 'da04ab7b97d79eb3cfc5d220c3a70bc40ca81af5', open: !!this.error, type: "danger" }, index.h("span", { key: '7ce3b38ca82df3ac8ba2c0972994f0cc0ace2726', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: '1e6a58b9247baad6b21d7cc02336c1c85988bd8e', class: "loader", hidden: this.loaded }, index.h("div", { key: '99dbde54edc28abbf7a13902dfe1c3b5bb7f4a98', class: "loader__row" }, index.h("div", { key: '6a418ec6217ab2e7b207d145b44c6e8c0667996e', style: { width: '50%' } }, index.h("sc-skeleton", { key: '1e47dc264e915ea92847f68aad96eb017ff2cdff', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: 'fd902d4fcf9eabb3a748e87c95e3d50859756f6c' })), index.h("div", { key: 'debafde18c1ff3dbca6b0cf108d2c84864492b80', style: { flex: '1' } }, index.h("sc-skeleton", { key: '6e7e24e728c4fdca1e5f8e4043c26755107ed6b2', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: 'df115807eac1b5042889de40cbcefd5d100a2f61' })), index.h("div", { key: '0cdeaa1e26ad52979fca4edca2dac33356600a0b', style: { flex: '1' } }, index.h("sc-skeleton", { key: '99c4fdbff4469ccac2abd13419db6cddae70aec7', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '42b376158fa82ac2f1470970f1e05eaa40c28631' }))), index.h("div", { key: 'db7dd567e2cbc31da6afc55f0748dcaa3cdfea61', class: "loader__details" }, index.h("sc-skeleton", { key: '4d043c24b6beaa985f468022964ed7010f310434', style: { height: '1rem' } }), index.h("sc-skeleton", { key: '20b5994e37f00a0daa1ea9dd9f96785d66f6f69c', style: { height: '1rem', width: '30%' } }))), index.h("div", { key: 'a0673556b97821f57304ce58a2aee394a4d0aa5e', hidden: !this.loaded, class: "sc-payment-element-container", ref: el => (this.container = el) }), index.h("sc-button", { key: 'efe7c01fdc7f9a3da183108489578aaab2cc841b', type: "primary", submit: true, full: true, loading: this.loading }, wp.i18n.__('Save Payment Method', 'surecart'))));
    }
