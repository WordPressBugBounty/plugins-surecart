...
const ScAlert = class {
    ...
    render() {
        return (index.h(index.Host, { key: '92ea5c6d8ee175b4f748c4515a417a9b71622a51', style: { 'scroll-margin-top': this.scrollMargin } }, index.h("div", { key: 'cddf8278beea58242817e75172fb80b1eb8f7702', class: {
                'alert': true,
            ...
            }, part: "base", role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', hidden: this.open ? false : true, onMouseMove: () => this.handleMouseMove() }, index.h("div", { key: '881ce259f7879603e56d786fe54ee840dbb8194c', class: "alert__icon", part: "icon" }, index.h("slot", { key: '4c83e7aa16de81d30e768f7d419f503117038501', name: "icon" }, this.icon())), index.h("div", { key: 'c6d9dacb9dab4ea34d4a18daf006909b9a0f5ce6', class: "alert__text", part: "text" }, index.h("div", { key: 'a20a3d57e38ed3656266df90e151364e232d159a', class: "alert__title", part: "title" }, index.h("slot", { key: 'f3687ae953760ea7320045af926bc48179f1c4db', name: "title" }, this.title)), index.h("div", { key: '9878ab34d35b28e4002e4a225bfc0f8e368a666b', class: "alert__message", part: "message" }, index.h("slot", { key: 'ddb1e8051e6409ee98272750a855964ea867880f' }))), this.closable && (index.h("span", { key: 'be7f13bb17f4a6604d612697f0798bb06c5a0283', part: "close", class: "alert__close", onClick: () => this.handleCloseClick() }, index.h("span", { key: '1979db86c4569bad91eb7e09c597494ceb08303c', class: "sr-only" }, "Dismiss"), index.h("svg", { key: '2ab64fdb704d054a5e4d601d75e8836ec2309e4d', class: "h-5 w-5", "x-description": "Heroicon name: solid/x", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, index.h("path", { key: 'a61dec77ea84a4773e9ab316905baf2b608a3767', "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))));
    }
