...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: '6340be117cd4d5dd5fcd9c8a9bacadc8c107dfc9', class: "purchase", part: "base", heading: wp.i18n.__('Downloads', 'surecart') }, index.h("span", { key: 'b1fcc2593e0330f14e8b00e1200ff88fae7cd74d', slot: "heading" }, index.h("slot", { key: '1cdc4b09470a3a457a080a1367a116c2fdc2a6e8', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), this.renderList(), index.h("sc-pagination", { key: '961e76eea74a2298c078798a2b4566547ddeb203', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.downloads) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }), this.busy && index.h("sc-block-ui", { key: 'd1ffbef22d4d483d0fa059ea1ae9e918e8727c10' })));
    }
