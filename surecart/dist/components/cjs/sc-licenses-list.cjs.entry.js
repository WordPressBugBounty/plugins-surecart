...
const ScLicensesList = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: 'b9693fc82d4c2ededfeaaaffb8241af8b6b9a00f', class: "purchase", part: "base", error: this.error }, index.h("span", { key: 'dfd88115cb93987e14db0935858ed766d1a083f2', slot: "heading" }, index.h("slot", { key: 'f94c901827b2f8753f9698787d1877581a4c32e0', name: "heading" }, this.heading || wp.i18n.__('License Keys', 'surecart'))), !!this.allLink && !!((_a = this.licenses) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: '6ee372977c9ea2ffbad47739005e66431201d14a', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: '9bcc7ad765b9b8a24c2df30a0cc28dfefd1adced', name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: '8b455269c99f5910599c8f92c95e500d632013d2', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.licenses) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }))));
    }
