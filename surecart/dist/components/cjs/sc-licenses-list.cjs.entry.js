...
const ScLicensesList = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: 'd3161b92e18f71c2284ecce18a148fc29df840f7', class: "purchase", part: "base", error: this.error }, index.h("span", { key: '10c56a8cf4cdfa682bd8bf64cb68f2f6f8854113', slot: "heading" }, index.h("slot", { key: '7d2821f06c98257977bd83e84ac8698761b140c9', name: "heading" }, this.heading || wp.i18n.__('License Keys', 'surecart'))), !!this.allLink && !!((_a = this.licenses) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: 'a43f0a85f06b82e396e86cd6ae7e68c3537f0995', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'cac9d7dbd801425fe6e4f4b424bf0e9b1bea690d', name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: 'ec9078a5d84f955225c47a2bfb42f392cdaa2c91', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.licenses) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }))));
    }
