...
const ScChargesList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: '34768e83fcba7bd31d314612dd3b1e1b72ae1176', class: "charges-list", error: this.error }, index.h("span", { key: 'fc128cba5a6cf53f8ef22ac6e80ad9a543e3c171', slot: "heading" }, index.h("slot", { key: 'f18538dd413bf2c41636d165b6e2417c5c315b11', name: "heading" }, this.heading || wp.i18n.__('Payment History', 'surecart'))), !!this.allLink && (index.h("sc-button", { key: '6625729e42467b16711f19219703685fbd6d9385', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'af6087c553c63182319c703114dd8cabc43a6cae', name: "chevron-right", slot: "suffix" }))), index.h("sc-card", { key: 'bfdce8373f67a661f4556016c9b722e27a452e86', "no-padding": true, style: { '--overflow': 'hidden' } }, index.h("sc-stacked-list", { key: 'e77ba5160a42ce04c7faed7401281d55dc225b3b' }, this.renderContent())), this.showPagination && (index.h("sc-pagination", { key: '07bed22982a1e07cd4fda01664d536a21818d113', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.charges) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.loading && this.loaded && index.h("sc-block-ui", { key: '34255b2858c403e9617a5173ebaa06a9e43f1aad', spinner: true })));
    }
