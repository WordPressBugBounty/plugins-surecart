...
const ScChargesList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: 'd952031956a9b21509b43f857a1c47fc4e5660d5', class: "charges-list", error: this.error }, index.h("span", { key: '7c0bc577d73ae74d19ebd5115f5d4d813ea4f2ed', slot: "heading" }, index.h("slot", { key: '35fc89d544005a0ebf54a14f69dc26af0a0edd19', name: "heading" }, this.heading || wp.i18n.__('Payment History', 'surecart'))), !!this.allLink && (index.h("sc-button", { key: '0b02c6e66a083e7b63ab42cd887340bda54cbf1a', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: '88bdb3b90523aa6fd05c8c4e8e394d5644c7f84c', name: "chevron-right", slot: "suffix" }))), index.h("sc-card", { key: '47e52e9edc58869eadfd50b5287ad7706ddba91e', "no-padding": true, style: { '--overflow': 'hidden' } }, index.h("sc-stacked-list", { key: 'df8967e8d9736d3b9c8ccdb51d79aaa30e69275d' }, this.renderContent())), this.showPagination && (index.h("sc-pagination", { key: '022d0eb2d612b0913a8b82aa3dd60eb054113d02', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.charges) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.loading && this.loaded && index.h("sc-block-ui", { key: '75de67c1c76dd15ddb0dfc773324bd88dc3c7a46', spinner: true })));
    }
