...
const ScChargesList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: '19671089fb831179a4dd19693b7588734d93e7d7', class: "charges-list", error: this.error }, index.h("span", { key: '7d21620307f7a43f4a6bd718b9f70dc18aafb2be', slot: "heading" }, index.h("slot", { key: '835f2608215382b105567cbf769b820d0500bfc1', name: "heading" }, this.heading || wp.i18n.__('Payment History', 'surecart'))), !!this.allLink && (index.h("sc-button", { key: 'bb6899f6f0c1ce730a021596cee3eb498621f9e0', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: '873226cd25978e5a088a1dfe31cd34bb77519cba', name: "chevron-right", slot: "suffix" }))), index.h("sc-card", { key: 'c480a89e6e1451229658077c078f581e6f08c42e', "no-padding": true, style: { '--overflow': 'hidden' } }, index.h("sc-stacked-list", { key: '5c55a55deaff138c29c1b9f3420f105c8301f0b6' }, this.renderContent())), this.showPagination && (index.h("sc-pagination", { key: '6da999a032e0c6f2f180ba2433876a04b30a4764', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.charges) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.loading && this.loaded && index.h("sc-block-ui", { key: '1ac84f292015a5a143a76970c41df38ddd80363e', spinner: true })));
    }
