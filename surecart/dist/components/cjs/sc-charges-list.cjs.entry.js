...
const ScChargesList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: '4bff2aa5b6a9730e58a62e99185eb142d5b481a3', class: "charges-list", error: this.error }, index.h("span", { key: '5423f7a4bb3898f58035e7f57bb78d7096640dbc', slot: "heading" }, index.h("slot", { key: '2976371f97c26a934b6ccfeb9495e483bbaad940', name: "heading" }, this.heading || wp.i18n.__('Payment History', 'surecart'))), !!this.allLink && (index.h("sc-button", { key: '45d0a8cbc5db519c973782004f514299bcd4e574', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'f683c4fa2b3697800de9152957edb0941c5e7130', name: "chevron-right", slot: "suffix" }))), index.h("sc-card", { key: '11a3d342da7ddbf7139253b742900122ad28efb5', "no-padding": true, style: { '--overflow': 'hidden' } }, index.h("sc-stacked-list", { key: '29d259661e86e3835291d35e7aa353f0b8b2f325' }, this.renderContent())), this.showPagination && (index.h("sc-pagination", { key: 'dc09932e2939ff648ef61798e33230cbee85de1b', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.charges) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.loading && this.loaded && index.h("sc-block-ui", { key: '6de6993b582447bcb9a7846e706888e4e2bf899e', spinner: true })));
    }
