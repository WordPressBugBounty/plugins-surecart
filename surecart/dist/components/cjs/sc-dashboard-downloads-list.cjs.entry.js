...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-purchase-downloads-list", { key: '8c482ebb1071c4edd547c25cb444354f84e221f2', heading: this.heading, allLink: this.allLink && this.pagination.total_pages > 1 ? this.allLink : '', loading: this.loading, busy: this.busy, requestNonce: this.requestNonce, error: this.error, purchases: this.purchases }, index.h("span", { key: '68258a0e8d6e47d633624e65c2ebc537d3dc1881', slot: "heading" }, index.h("slot", { key: 'e328b925a60667d47971647d7043020d2c6466fc', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), index.h("sc-pagination", { key: 'c3fdb7c3e1e626dc79723cddbc4a27e85c4490f4', slot: "after", page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.purchases) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })));
    }
