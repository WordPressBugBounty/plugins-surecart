...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-purchase-downloads-list", { key: '76f37622c81d8d83eb914210ed3e7af34d1de79f', heading: this.heading, allLink: this.allLink && this.pagination.total_pages > 1 ? this.allLink : '', loading: this.loading, busy: this.busy, requestNonce: this.requestNonce, error: this.error, purchases: this.purchases }, index.h("span", { key: 'fd8706be18f6ae42634bbac3fb77562314c36b3a', slot: "heading" }, index.h("slot", { key: '312de126f419b49bd5769bdcaabb028c45905afe', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), index.h("sc-pagination", { key: 'c9285ccad8a749eb72ef6474b92d1c5b49575b28', slot: "after", page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.purchases) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })));
    }
