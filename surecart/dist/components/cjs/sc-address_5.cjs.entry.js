...
const ScAddress = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3ef05ecc0dc11c2c06995dda7befb9d63e7a2c64', class: "sc-address", part: "base" }, index.h("sc-form-control", { key: '0e934e029358f398ba0c0df294fa4031fcc99158', label: this.label, exportparts: "label, help-text, form-control", class: "sc-address__control", required: this.required }, topFields.map((field, index) => {
            const roundedProps = this.getRoundedProps(index, totalForRounding);
            return this.renderField(field, roundedProps, this.required);
        }), index.h("div", { key: 'b1b1b1e35d675dfb3918c623f12835d4591c4476', class: {
        ...
        }))), this.loading && index.h("sc-block-ui", { key: '13cbd4285d118a3bb0cba4586678c4d9616aaac8', exportparts: "base:block-ui, content:block-ui__content" })));
    }
...
const ScAddressSuggestions = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b5ccd3ff6cc18173bf027ff918190c9e9728f1be', part: "base" }, this.isGoogleMapsActive() && index.h("span", { key: '2a24cda0c2549d8e06744cadb37c55057057d8a1', class: "sr-only" }, wp.i18n.__('Start typing to see address suggestions, or select one to auto-fill your address.', 'surecart')), index.h("sc-input", { key: '2cc1937d21b3bb7159ed5e124157484fc2288c4a', exportparts: "base:input__base, input, form-control, label, help-text", value: this === null || this === void 0 ? void 0 : this.value, onScInput: (e) => this.handleInputChange(e), onScChange: (e) => this.handleInputValueChange(e), autocomplete: "address-line1", placeholder: this.label, "aria-label": this.label, "aria-expanded": suggestionsVisible ? 'true' : 'false', "aria-controls": suggestionsVisible ? 'address-suggestions-listbox' : undefined, "aria-activedescendant": this.getActiveDescendantId(), role: "combobox", name: (_a = this.names) === null || _a === void 0 ? void 0 : _a.line_1, disabled: this.disabled, required: this.required, ...this.inputProps }), index.h("div", { key: '23af33bf472ca2c692ec42a583278fde307f27f9', role: "status", "aria-live": "polite", "aria-atomic": "true", class: "sr-only" }, this.getSuggestionsStatusText()), index.h("div", { key: 'a80f5179bb9ba601de113024d350594de19564c4', class: {
