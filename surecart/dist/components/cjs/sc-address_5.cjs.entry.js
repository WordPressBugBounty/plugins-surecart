...
const ScAddress = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c50e39fc3ff1d188edda8d0ee8cd0feaa9f32fc0', class: "sc-address", part: "base" }, index.h("sc-form-control", { key: '3feb2671e2e236673b6c49d2e5cbbf7a46277294', label: this.label, exportparts: "label, help-text, form-control", class: "sc-address__control", required: this.required }, topFields.map((field, index) => {
            const roundedProps = this.getRoundedProps(index, totalForRounding);
            return this.renderField(field, roundedProps, this.required);
        }), index.h("div", { key: '2ac0c247a7ced41bfb18815570e4072757edc352', class: {
        ...
        }))), this.loading && index.h("sc-block-ui", { key: '38886fdc3dce81542ebecda95d10a8492dd92f34', exportparts: "base:block-ui, content:block-ui__content" })));
    }
...
const ScAddressSuggestions = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'bd54eacaf2863e723b98311258fee018b5b8437b', part: "base" }, this.isGoogleMapsActive() && index.h("span", { key: '7ca7dda4f0b84c163c8594a80aad733fd670ee77', class: "sr-only" }, wp.i18n.__('Start typing to see address suggestions, or select one to auto-fill your address.', 'surecart')), index.h("sc-input", { key: 'dd8b7477a70237b20ce168e6a86bebb717dced6f', exportparts: "base:input__base, input, form-control, label, help-text", value: this === null || this === void 0 ? void 0 : this.value, onScInput: (e) => this.handleInputChange(e), onScChange: (e) => this.handleInputValueChange(e), autocomplete: "address-line1", placeholder: this.label, "aria-label": this.label, "aria-expanded": suggestionsVisible ? 'true' : 'false', "aria-controls": suggestionsVisible ? 'address-suggestions-listbox' : undefined, "aria-activedescendant": this.getActiveDescendantId(), role: "combobox", name: (_a = this.names) === null || _a === void 0 ? void 0 : _a.line_1, disabled: this.disabled, required: this.required, ...this.inputProps }), index.h("div", { key: 'a45ae47b89585721c4ebfad8926b9804aaffbda9', role: "status", "aria-live": "polite", "aria-atomic": "true", class: "sr-only" }, this.getSuggestionsStatusText()), index.h("div", { key: '3333e28a1d13d7a616f6b196d50032db7e2c4b78', class: {
...
const ScCheckbox = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '3fd749e0dd317f2fdb75619ca560914b314c3e69', part: "base", class: {
                'checkbox': true,
            ...
            }, htmlFor: this.inputId, onMouseDown: () => this.handleLabelMouseDown() }, index.h("span", { key: '90bb7c1ac5bf13366b3228e1420f690778e891f5', part: "control", class: "checkbox__control" }, this.checked ? (index.h("span", { part: "checked-icon", class: "checkbox__icon" }, index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" }))))))) : (''), !this.checked && this.indeterminate ? (index.h("span", { part: "indeterminate-icon", class: "checkbox__icon" }, index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(2.285714, 6.857143)" }, index.h("path", { d: "M10.2857143,1.14285714 L1.14285714,1.14285714" }))))))) : (''), index.h("input", { key: '3cd246bd970f09c7eb3c289223fe844d8a7bbd85', id: this.inputId, ref: el => (this.input = el), type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, role: "checkbox", "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), index.h("span", { key: '529ad38ed6f327cb6cdb5c64afd989aedb54b648', part: "label", id: this.labelId, class: "checkbox__label" }, index.h("slot", { key: 'b5cfe55e10f6baab43b2ffce36af83a0b06d5bb1' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'a618f0c99f060ba31a8aacab44804ad56b275057', hidden: this.hidden }, index.h("sc-form-control", { key: '88d2922dea839f89101e2671ad8a8da1bca7ac36', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, index.h("slot", { key: 'e9293f18e87eb978581cb89877f3c9d4a10fd53b', name: "label-end", slot: "label-end" }), index.h("div", { key: '175f52bcca4538f3f0f554dac1376628b57ff3a5', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: '00a0b850b7bdc3bb13f6ec32fa1513bcbafc5b33', part: "prefix", class: "input__prefix" }, index.h("slot", { key: '0f75c7e29f62917bcebc6e19e53b3e338e429459', name: "prefix" })), index.h("slot", { key: '8b68a4a453558bde5b58b79dd6309d1eb2397666' }, index.h("input", { key: 'fb972307d81dbdc904531af7bb7371ff22e2a852', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: index$1.applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), index.h("span", { key: '4e9d1456896ac18ab36a06958c5cb0730a0d76c0', part: "suffix", class: "input__suffix" }, index.h("slot", { key: '3b326f408b9eb496c5664f81b98e89d264af914e', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: 'b18a3beaff2eee4c6cdb775217294f9ed7ea5e50', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: 'f229ed62379f0cf2ef497b3e5f1b5e3f2f6d15cc', name: "clear-icon" }, index.h("svg", { key: 'e3ae229961748f770b49783d00b713bfc8406360', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: 'daa51e25f434e1bfe12bbdac7bc61cccf4bc6c3c', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: 'c3e2d0b4d06762344edd9e573b003a83a402b13a', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Fragment, { key: '9f331fb676f0f9167bc623cc1915837b7e452693' }, index.h("sc-input", { key: 'dde3d59aedabba72f5489ab3c897116825e93d3b', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), index.h("sc-input", { key: '960d1d83c7d5dcc59f4edee06321dd40283c5a65', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
