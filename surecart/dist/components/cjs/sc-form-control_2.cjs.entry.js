...
const ScFormControl = class {
    ...
    render() {
        return (index.h("div", { key: '7cc653d32ae4b95fad41f6e0fe8d3e51bf2991a6', part: "form-control", class: {
                'form-control': true,
            ...
            } }, index.h("label", { key: '5cfb4310d3bf9dc0e9951e0b9f796d4359292234', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, index.h("slot", { key: '8d419e0fa37a30887b650bf76a78d7720711e5fe', name: "label" }, this.label), index.h("slot", { key: 'a9603557631f9f99f858bffe1464f6955f8b454a', name: "label-end" }), !!this.required && (index.h("span", { key: 'b27a00aee94c00e953bae7634619fe9765928396', "aria-hidden": "true", class: "required" }, ' ', "*")), index.h("sc-visually-hidden", { key: '4a8d0f9297a738e95788e8be9dc03a565e9b6997' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), index.h("div", { key: '93e0e991da63e52a9079ff076a75c18cf5ecbde7', part: "input", class: "form-control__input" }, index.h("slot", { key: 'f737923462655a830b10254446e6ac26fe5d17e1' })), this.help && (index.h("div", { key: '397a92ad1f6fe067ef6552c81cd954d27e122488', part: "help-text", id: this.helpId, class: "form-control__help-text" }, index.h("slot", { key: 'c7778d7f76a5e9126d747b342ec03b55130509e1', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '7cf9127e65191dae30f4de13b1921e0c6782f392', hidden: this.hidden }, index.h("sc-form-control", { key: 'cbe94938682592dc87d2bc1fa4b8b2863e7fa515', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("slot", { key: 'df90f3cda88a9f7b864636525bfb06d0d08d1549', name: "label-end", slot: "label-end" }), index.h("div", { key: '1bc4f53d3fb318ad622796b32f4447f11bb43944', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: '17bfd384f85798d9d7660261ebe56dbe48a7848c', part: "prefix", class: "input__prefix" }, index.h("slot", { key: '64bd912bf0e2382c0de30e06ad9db99528e74ee3', name: "prefix" })), index.h("slot", { key: 'a9393099a5bd89f6083d1d8d61cec2aef438898d' }, index.h("input", { key: '807591a580773108310a75f3e4502118da056210', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), index.h("span", { key: '5525dc9d027503d39e683ce6aedebf02870a40bc', part: "suffix", class: "input__suffix" }, index.h("slot", { key: '9a153bff727977715387c44c0288b1fcc173a0b5', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: '9211ed54e06ed08bbb64a2483d932df801724d5b', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: '274e5fe48f12c1262391d06ac36b94e11faf62e1', name: "clear-icon" }, index.h("svg", { key: '5834a1540b17cf0782b3629decb7f7980c1854ac', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: '6c45d75942069af63cde82dca005eb7a7a40ce8f', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: '735a4a287e284d7596f55e731dbe845019e7ea56', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
