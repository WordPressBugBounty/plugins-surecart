...
const ScFormControl = class {
    ...
    render() {
        return (index.h("div", { key: 'a5f30f084bb384df1bb3e1dbb8d25e08e547d8e2', part: "form-control", class: {
                'form-control': true,
            ...
            } }, index.h("label", { key: 'b681dc4c755214193697db5b94f8270101097d27', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, index.h("slot", { key: 'bfdd9680ed33be5224be380d08e80e16f9d432eb', name: "label" }, this.label), index.h("slot", { key: '2e83e1d2994e374700600c040cb3d235c7c481c0', name: "label-end" }), !!this.required && (index.h("span", { key: 'fc44ec0e54e3de81a99dd1e23b75a0f1e28e687c', "aria-hidden": "true", class: "required" }, ' ', "*")), index.h("sc-visually-hidden", { key: '438ba1ccb147bd5fc45f1e032258c1547eed6f73' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), index.h("div", { key: 'ac5ecce500a3eb7bdc2d43f611a4c122c4dae023', part: "input", class: "form-control__input" }, index.h("slot", { key: 'c4ef3d2ca4444bc23b107dd7800dbda8d8e35824' })), this.help && (index.h("div", { key: '7ac4700e38c10056a418b151ef47ac7dd52a9240', part: "help-text", id: this.helpId, class: "form-control__help-text" }, index.h("slot", { key: 'c3250ab9f5923d7a40f5849ffd7a2f8ccac0344d', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '63f0990eb557b7233363e8214261a2b1812628c8', hidden: this.hidden }, index.h("sc-form-control", { key: '9ab171e35b59f8664e7f5191a8b7322ef01291d5', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("slot", { key: 'a68c5932d6ba19b303ddf12bc438e7fc644030d7', name: "label-end", slot: "label-end" }), index.h("div", { key: '825865ea695089d22158180062ff8cb1c1e2a765', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: '76858f7a2a2f882a28737601ec77ca8bb5608d12', part: "prefix", class: "input__prefix" }, index.h("slot", { key: 'db0891788bc0084892d91a14e0f58d226ac65135', name: "prefix" })), index.h("slot", { key: '49cc9670268cebe2b5c8943eb9b9875d0fe96a00' }, index.h("input", { key: '83110404e8af860c2de35ca7f00553b8bef69f02', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), index.h("span", { key: 'cf1d4fa115f577be9b8e0c99f76bc2c47f655eca', part: "suffix", class: "input__suffix" }, index.h("slot", { key: '6ec9ade9777492fcaa0bea145e43a87d75f25a83', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: '6e443ff27859f943845f45fedb3bc9697bc8962d', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: '3135a1d6af1cdd52416d86839d25a195934bb2c5', name: "clear-icon" }, index.h("svg", { key: '24bb8dbaa425a52b1553ca50e1d47822cf14e798', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: 'e1d2145af0f18578ef64546193cc5260c4d00b96', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: '4f408a60e67cd03191d73847e27d5f7f24b72026', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
