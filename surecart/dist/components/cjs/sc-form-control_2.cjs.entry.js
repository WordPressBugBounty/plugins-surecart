...
const ScInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'd5f54f7a99a7032a4d45a55dcb5df15147bb62b0', hidden: this.hidden }, index.h("sc-form-control", { key: 'c436e483f8bce6720816bcb453e140b2c1c55f9e', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("slot", { key: '328240a9826f2e72960ffe1a5fd48feae060e55a', name: "label-end", slot: "label-end" }), index.h("div", { key: '4ffc3057830526ad16db735bc13b7778d52f06c2', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: '28d49b45f68df25ca824a3bf601e30800f7e9745', part: "prefix", class: "input__prefix" }, index.h("slot", { key: '0bf172479696f10b07d223f42f823bf9f3f2a9c6', name: "prefix" })), index.h("slot", { key: 'd2a506079105f340512f981a99c6f1c1f720da3b' }, index.h("input", { key: 'a598d82ea9e032131a4617ab6b4e04ebab3e05c3', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), index.h("span", { key: '83deed7e186368dea808fde1f2fbce74a8d1e581', part: "suffix", class: "input__suffix" }, index.h("slot", { key: '862618ccdb309fa8e0d3758e95849f18c6c5867c', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: '4a8e8768c086ff02390a6f22d61b1ee2362bd655', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: 'e15e9163c3724dd06930fbce6a3f434c15ca9ec4', name: "clear-icon" }, index.h("svg", { key: 'ee5993472d8b9b1f28025360d36959bb11b30504', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: '3ad6e61797f9b5f3de81a0529a4c9e8af3b73b3a', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: 'ee34245d8b73ee76e9324ded80fbf945803ea5cd', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
