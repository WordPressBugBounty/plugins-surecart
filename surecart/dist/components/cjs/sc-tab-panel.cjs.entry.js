...
const ScTabPanel = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6a9c0f23335bd2b4ee1f9ade6ad4d2f3957ca42f', style: { display: this.active ? 'block' : 'none' } }, index.h("div", { key: '4d3b387a8846b95aadcc19bab79365cd38bfe3cd', part: "base", class: "tab-panel", role: "tabpanel", "aria-hidden": this.active ? 'false' : 'true' }, index.h("slot", { key: 'e82dde39a3dec65b0994511def273a3fe25341c6' }))));
    }
