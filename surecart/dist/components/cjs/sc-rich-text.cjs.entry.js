...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: '8199b674e8613efba980cd9047e39b9f52c0f493' }, index.h("sc-form-control", { key: '7ea74d86b4c015aa52127fbfa4073adc9a62777b', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: '41018d7784b9b63c54b0f20fdfd146850a1d12be', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, index.h("div", { key: '0236c87089ab46839dfdeec21ad7d1ab51ef207e', class: "menu" }, index.h("sc-button", { key: 'b86ca0b4c25069ff4e7397e2a398440edd97ca65', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, index.h("sc-icon", { key: '4e1eb1cb842e40d0b4b237bc8c9ea21f6585b261', name: "bold" })), index.h("sc-button", { key: '721a136152f896dc88033690563b646162bfd3a3', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, index.h("sc-icon", { key: '2eca3d048f2820e0ebc53b5bcf2f1365b064b441', name: "italic" })), index.h("sc-button", { key: '11bb910804ff6f85fc1de23b8d33c2c17a71ac51', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, index.h("sc-icon", { key: 'ef67b69074a704a604094e6ec36ad6054af75fff', name: "list" })), index.h("sc-button", { key: 'ac631ba479c7600485c44e2b1429a99c0fd3202a', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, index.h("sc-icon", { key: '6b2552a4910db12d1ff2493986bc93a72021361f', name: "minus" })), index.h("sc-button", { key: '453ffa1a5ef600a4769afba180078fa8a6df51b2', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, index.h("sc-icon", { key: '042639205209203be3959ebf1763a517ed92702b', name: "corner-up-left" })), index.h("sc-button", { key: 'f8f8e9fd6b3cfcf9356173ed735be704d33e5cac', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, index.h("sc-icon", { key: '339d1d35a526534de1b1a352b73ca5bc71be89d5', name: "corner-up-right" }))), index.h("div", { key: 'd0e25168c140b72cd9671ed25d016ea955e866d3', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && index.h("div", { key: '4198a092206a245804ef43b1f9252a2ed0bf82e7', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
