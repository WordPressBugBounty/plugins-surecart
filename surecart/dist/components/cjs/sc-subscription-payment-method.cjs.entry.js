...
const ScSubscriptionPaymentMethod = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: 'a31f28d9f73111c79225fdd0808bd08b3ffe6c40', heading: this.heading || wp.i18n.__('Update Payment Method', 'surecart'), class: "subscription", error: this.error }, index.h("sc-button", { key: '8c3d616964e69c98b02fdd63b9d8bf9cc6461408', slot: "end", type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'create',
                model: 'payment_method',
                ...(((_a = this.subscription) === null || _a === void 0 ? void 0 : _a.live_mode) === false ? { live_mode: false } : {}),
                success_url: window.location.href,
            }) }, index.h("sc-icon", { key: '3a5490fe50b2b9238074f028d14da9b0d85097ac', name: "plus", slot: "prefix" }), wp.i18n.__('Add New', 'surecart')), this.renderContent(), this.busy && index.h("sc-block-ui", { key: '05a599c50f5178c1e9879ea333d78e475678c0b9', spinner: true })));
    }
