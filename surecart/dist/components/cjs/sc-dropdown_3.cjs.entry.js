...
const ScDropdown = class {
    ...
    render() {
        return (index.h("div", { key: 'e441923fb35721375eb517859b4b36c46432b321', part: "base", class: {
                'dropdown': true,
                'dropdown--open': this.open,
                'dropdown--disabled': this.disabled,
            } }, index.h("span", { key: '8ca99b58022738eef2b0f2ad2efe112a564fd415', part: "trigger", class: "dropdown__trigger", ref: el => (this.trigger = el), onClick: () => {
                if (this.disabled)
                    return;
                if (this.open) {
                    this.hide();
            ...
            }, "aria-expanded": this.open ? 'true' : 'false', "aria-haspopup": "true" }, index.h("slot", { key: '36019ea522f751deaae663b8f17e35b7bbc3da50', name: "trigger" })), index.h("div", { key: 'd0f0c27434c0b87bf34fa1630b76c2c533a0dadd', class: "dropdown__positioner", ref: el => (this.positioner = el) }, index.h("div", { key: '01cf8b10115845c477bec31db650f4f0476efbc3', part: "panel", class: {
            ...
            }, "aria-orientation": "vertical", tabindex: "-1", onClick: e => this.handleClick(e), ref: el => (this.panel = el) }, index.h("slot", { key: '6b21f22615785d9690091b499627be0ee6869de0' })))));
    }
...
const ScMenu = class {
    ...
    render() {
        return (index.h("div", { key: '60325efd7fab67f17c676fcda899ef0c8fb31162', part: "base", class: "menu", tabindex: "0", onKeyDown: e => this.handleKeyDown(e) }, index.h("slot", { key: '04f3cc7e3596ca52bc3b696dec8475e5d674d4b4', onSlotchange: () => this.handleSlotChange() })));
    }
    get el() { return index.getElement(this); }
};
...
const ScMenuItem = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '7b4393da38e7417d4dc2c643e54d1b04147ad18e', ref: el => (this.menuItem = el), part: "base", class: {
                'menu-item': true,
            ...
            }, "aria-label": this.el.innerText, target: this.target }, index.h("span", { key: '5a82ece53ab5bdc159ecaf81b9b5b77479afe1d3', part: "checked-icon", class: "menu-item__check" }, index.h("svg", { key: '0684556b713ab0e65b26e757ae4f73cb8de64de2', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", class: "bi bi-check", viewBox: "0 0 16 16" }, index.h("path", { key: 'db81b2f59cf49d53e9b7405560342ef7ee872740', d: "M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" }))), index.h("span", { key: '2f212dda79b3dd1cd4c257ae91e771ea8233215b', part: "prefix", class: "menu-item__prefix" }, index.h("slot", { key: 'b0b6e97b3b97702659f8e7d35ef0b3e532c4bd44', name: "prefix" })), index.h("span", { key: '85ac52204d42f3e4211b01631c57c0b9c8f23091', part: "label", class: "menu-item__label" }, index.h("slot", { key: '9e43cd4c810e6d7d25f6b053439c995714f1812f' })), index.h("span", { key: '8d7e66a1564823103f52acc99ab2a85b29677a26', part: "suffix", class: "menu-item__suffix" }, index.h("slot", { key: '16dc91447b73a6f208683e55711ca35c053ead92', name: "suffix" }))));
    }
    get el() { return index.getElement(this); }
};
