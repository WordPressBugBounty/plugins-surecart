...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (index.h("div", { key: '486eaadcd2d21c7b68575c25abb62e384bba89cb', class: "upcoming-invoice" }, this.error && (index.h("sc-alert", { key: 'b7b8fcb1f347384c700abbb6e73802b1adecbc52', open: !!this.error, type: "danger" }, index.h("span", { key: '1cbd63c8b69029649c32a12988e2dbce6e2f0c43', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h(index.Fragment, { key: 'cc99a7ee43f59c27dfabb5904b7a30ac57185cdb' }, index.h("sc-dashboard-module", { key: 'bf35b9b52a77d70841ffa4a0fde86b57decb179f', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, index.h("sc-card", { key: '5f0b08a2305adf44e852cf8829e634b4ddf61a52' }, this.renderContent())), index.h("sc-dashboard-module", { key: 'ff9cdbc290bcd05982261cc6cb03121b06b41613', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, index.h("sc-form", { key: '98019bff8bbf5d3c1a90c1d40f7d8989af617548', onScFormSubmit: () => this.onSubmit() }, index.h("sc-card", { key: '43876a686c27cfdcf07959a2cae80fae9f0088cc' }, this.renderSummary()), index.h("sc-button", { key: '583c952ad76872a6a53fda6631fbc2bd7f0d96e4', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), index.h("sc-text", { key: 'addf0baae1a1964bf78ec778270915a529ca2828', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, index.h("slot", { key: 'a546f2a563701a80a30e5d736b40110a474d8188', name: "terms" }))), this.busy && index.h("sc-block-ui", { key: 'c9d344f243ba506d4d50a81f3271f4c57d5854d0' })));
    }
