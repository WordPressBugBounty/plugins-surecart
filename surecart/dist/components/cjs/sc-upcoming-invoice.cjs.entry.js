...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (index.h("div", { key: '994e4674f13c1102cce91e32debe17f10d5fff78', class: "upcoming-invoice" }, this.error && (index.h("sc-alert", { key: '10571e0391c553b9c0bd55c82a57a7c4d858def3', open: !!this.error, type: "danger" }, index.h("span", { key: '57496037546b0e64c79a89f3e6f015bbb63a976a', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h(index.Fragment, { key: 'e0d516ceda369a6738395c9f804551a6d2bf0f2c' }, index.h("sc-dashboard-module", { key: 'e4eb56418146d529230ab63a66b2118ad085ad0f', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, index.h("sc-card", { key: 'cd1034d1569a2bcfd1cb1a939ccd307c153725de' }, this.renderContent())), index.h("sc-dashboard-module", { key: '00ee13ad64fd814671c8ad44bb969f152b3fb067', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, index.h("sc-form", { key: '1e5d9a4b02673369c644719a3fc5b9fa83f27549', onScFormSubmit: () => this.onSubmit() }, index.h("sc-card", { key: 'b05da08755e32811a645469b91e58c8db5f7c23b' }, this.renderSummary()), index.h("sc-button", { key: 'c9e09b546e82ec2e96cbf84c2aebcb3c61a741d0', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), index.h("sc-text", { key: '15a37643b1139bc9e6e955c56f353829b3b82151', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, index.h("slot", { key: '37bd18191d6ee96447ad079697e25aa6a2926b40', name: "terms" }))), this.busy && index.h("sc-block-ui", { key: '0dfe990352964dad214f73bbe1807438400a6ae4' })));
    }
