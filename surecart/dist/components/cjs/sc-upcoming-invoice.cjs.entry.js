...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (index.h("div", { key: 'ffee4d57612ae31103d269eac01ccedc7da659f0', class: "upcoming-invoice" }, this.error && (index.h("sc-alert", { key: '4d09ee44e7dda0cb28eeed9580f2d7db2f41d68a', open: !!this.error, type: "danger" }, index.h("span", { key: '5d9024405f6a980de0c28305b99d5baedc76de2c', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h(index.Fragment, { key: 'cc4c30598aa96a336b2d80cf23468a3bf0f2c27a' }, index.h("sc-dashboard-module", { key: '0273995bf65042a379397371ea5238c48c8743b2', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, index.h("sc-card", { key: '7ac5a5132ed75ae3995834be537018c5d22c9aac' }, this.renderContent())), index.h("sc-dashboard-module", { key: 'e7987f8730a6aa2a2566446e5e7be4b5f5a2f7a3', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, index.h("sc-form", { key: '10048213c15320ca32ef31cc6ec1692094331f69', onScFormSubmit: () => this.onSubmit() }, index.h("sc-card", { key: '4769c2e4a61545b7201bf5dc9b1d6052dffb42c6' }, this.renderSummary()), index.h("sc-button", { key: '5b22920446df957648145eff09c190e13496d8c1', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), index.h("sc-text", { key: '8e2bdcbb406d2560ea523293117678c42d7def47', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, index.h("slot", { key: '2a475f718d7c38f3f2be22b8b3caa2a8a4532d52', name: "terms" }))), this.busy && index.h("sc-block-ui", { key: 'ead380e3c2bfd18a53f033dccec3ff1452666afb' })));
    }
