...
const ScWordPressUser = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: 'ab0de328f2ddab100d35243ca7312e6a0f510f19', class: "customer-details" }, index.h("span", { key: '4b6f659e2fdd46a65828daf67adcff2059efb851', slot: "heading" }, this.heading || wp.i18n.__('Account Details', 'surecart'), " "), index.h("sc-button", { key: '0510428382eb332af7192ce7164f0d258845a631', type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'edit',
                model: 'user',
            }), slot: "end" }, index.h("sc-icon", { key: 'dc9a61ed6422c3e0afe5ead4ae8441ba6e4197f4', name: "edit-3", slot: "prefix" }), wp.i18n.__('Update', 'surecart')), index.h("sc-card", { key: '9055a042933e2148b4ead7f44b20ad76f17db7be', "no-padding": true }, index.h("sc-stacked-list", { key: 'c997a023ba9fc2747ec203fe9df81035a82b847d' }, this.renderContent()))));
    }
};
