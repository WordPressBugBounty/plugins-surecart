...
const ScRazorpayAddMethod = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cd3965b98fa5a9abf1879e0133223c265a00a913' }, this.error && (index.h("sc-alert", { key: '4efbeeae5ecda9f6fc6e4f9f997045a9eb1cb25c', open: !!this.error, type: "danger" }, index.h("span", { key: 'e28421a69041a185d20ee02b8b19532d1e2920c2', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: '12895a9cd590d9258b306ca6ecc2b33e5df7de69', class: "sc-razorpay-button-container" }, index.h("sc-alert", { key: 'b41357dbc05565f17e7a78c4a0be05d11a816bdf', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), index.h("div", { key: '563fb5ee066868c7d6d8071d5db835fb3bc74a04' }, index.h("sc-button", { key: '3228a4a587ec00927812888bb5b0f817a1947c31', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
