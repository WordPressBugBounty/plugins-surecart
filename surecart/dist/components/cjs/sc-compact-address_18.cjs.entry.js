...
const ScRadio = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: 'd99bbea0a965962572df3f72bd783e6fe0ae3e2f', part: "base", class: {
                'radio': true,
                'radio--checked': this.checked,
                'radio--disabled': this.disabled,
                'radio--focused': this.hasFocus,
                'radio--editing': this.edit,
            }, htmlFor: this.inputId, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: '01c4d4dac0b9d1c04e3eddc546d69ddf9245d845', part: "control", class: "radio__control" }, index.h("span", { key: '86e92e5cc4fdccecd5f6677c4659ebf6efb5ee9d', part: "checked-icon", class: "radio__icon" }, index.h("svg", { key: '6063d8e59d360660b88587079dd962de7e612232', viewBox: "0 0 16 16" }, index.h("g", { key: 'e47429ae4a6140074403e28ea891621912587309', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { key: 'd9ed1fce11d289332663388cf6dbae5f2a0caad8', fill: "currentColor" }, index.h("circle", { key: '92c39b8c34a6f1e5bf9017ed3cd2b330d0fe9ea3', cx: "8", cy: "8", r: "3.42857143" }))))), index.h("input", { key: 'e3c0c09cc673f501c4d758f76578409683d5865f', id: this.inputId, ref: el => (this.input = el), type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), index.h("span", { key: '1ef51bb9dd1c0046af819df6b85959e04376435c', part: "label", id: this.labelId, class: "radio__label" }, index.h("slot", { key: '6aebf60d8972c83128fb5fe189c7cadb8dddf373' }), index.h("slot", { key: 'b8b415dc73873e4f1d41b0fbb8f1071abe8479ae', name: "description" }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScRadioGroup = class {
    ...
    render() {
        return (index.h("fieldset", { key: '8bd58c819c211da7c51698b21e713902d58d02ab', part: "base", class: {
                'radio-group': true,
                'radio-group--invalid': this.invalid,
                'radio-group--is-required': this.required,
                'radio-group--is-rtl': pageAlign.isRtl(),
            }, "aria-invalid": this.invalid, role: "radiogroup" }, index.h("legend", { key: '9f88af737634f9ff44edfbcf3792a4b8340dbc6d', part: "label", class: "radio-group__label" }, index.h("slot", { key: '6d3b5ca6dce5e1a66ba7bd2e697894a27f3b5e6f', name: "label" }, this.label)), index.h("input", { key: 'aacd44954b08158476773bed58018ead6f370ae4', type: "text", class: "radio-group__hidden-input", ref: el => (this.input = el), required: this.required, value: this.value, tabindex: "-1" }), index.h("div", { key: '12c3f5c6e704182102fb9256d340789c96b4741f', part: "items", class: "radio-group__items" }, index.h("slot", { key: '8b94009648800d7cbcdcc709b35b076c628ee0cb' }))));
    }
    get el() { return index.getElement(this); }
};
