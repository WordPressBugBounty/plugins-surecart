...
const ScOrdersList = class {
    ...
    renderList() {
        return this.orders.map(order => {
            ...
            return (index.h("sc-stacked-list-row", { href: addQueryArgs.addQueryArgs(window.location.href, {
                ...
                } }, wp.i18n.sprintf(wp.i18n._n('%s item', '%s items', itemsCount, 'surecart'), itemsCount))), index.h("div", { class: "orders-list__status" }, this.renderStatusBadge(order), index.h("sc-order-shipment-badge", { context: "customer", status: order === null || order === void 0 ? void 0 : order.shipment_status })), index.h("div", null, amount_due_display_amount)));
        });
    }
    renderContent() {
        var _a;
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: 'f842a533830a5cba0db880a5ffe8f9679ce31e51', class: "orders-list", error: this.error }, index.h("span", { key: 'c2996f07715e1fb14289e240f05d82299092faf4', slot: "heading" }, index.h("slot", { key: '5a924539f6699d4d0161a36f706be0ab1deb030e', name: "heading" }, this.heading || wp.i18n.__('Order History', 'surecart'))), !!this.allLink && !!((_a = this.orders) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: 'c077147bd37fc9521cbab57e3b7eeeaf551cb7a9', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Order History', 'surecart')) }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'a5b5f0accfcf4371f0450e2d265cd884330a1408', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: '019179a40ba565798cbd9ac6fc5349c8e328c07e', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.orders) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && index.h("sc-block-ui", { key: 'c60aa126b1a0c10fcb6b676dfcceab92738b194e' })));
    }
