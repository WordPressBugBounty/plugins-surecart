...
const ScButtonGroup = class {
    ...
    render() {
        return (index.h("sc-form-control", { key: '670a71100bef02c3c1ba247c7eb212f95d9365c8', part: "base", class: {
                'button-group': true,
                'button-group--separate': this.separate,
            }, role: "group", "aria-label": this.label, onFocusout: e => this.handleBlur(e), onFocusin: e => this.handleFocus(e), onMouseOver: e => this.handleMouseOver(e), onMouseOut: e => this.handleMouseOut(e), label: this.label }, index.h("slot", { key: 'e5a818d570e09f76934170b219be96f90ad6e620', onSlotchange: () => this.handleSlotChange() })));
    }
