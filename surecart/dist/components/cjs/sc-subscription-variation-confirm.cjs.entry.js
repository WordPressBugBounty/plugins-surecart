...
const ScSubscriptionVariationConfirm = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '051a98db675b9d147522e1c4be5affa7f226f091', heading: this.heading || wp.i18n.__('Enter An Amount', 'surecart'), class: "subscription-switch" }, index.h("sc-card", { key: 'dc12f61e159072e308388730966dbeaa953814e8' }, index.h("sc-form", { key: '63be25b8984c9ad00f7e8d5d3317fddd0cf2760c', onScSubmit: this.handleSubmit }, index.h("div", { key: '56d9063ee0807c748e7c6d44bcde085b4fb95bfb', class: "sc-product-variation-choice-wrap" }, (((_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.variant_options) === null || _b === void 0 ? void 0 : _b.data) || []).map(({ name, values, id }, index$1) => {
            var _a, _b;
        ...
        })), index.h("sc-button", { key: '4893e9d8690a1755c209e073e9dba6a4576a301b', type: "primary", full: true, submit: true, loading: this.busy }, this.buttonText(), " ", index.h("sc-icon", { key: '1cb541dc261cdd0624d5519f5737dcfc7ebe7fbe', name: "arrow-right", slot: "suffix" })))), this.busy && index.h("sc-block-ui", { key: '5f261680831193e1095b04a9d06a1847864b46c2', style: { zIndex: '9' } })));
    }
};
