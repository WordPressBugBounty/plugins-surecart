...
return array(
	...
	'shipping_rate.calculatable.shipping_provider.blank'   => __( 'Select a shipping provider.', 'surecart' ),
	'shipping_rate.calculatable.service_tokens.blank'      => __( 'Select at least one carrier service.', 'surecart' ),
	'shipping_rate.calculatable.amount_handling.greater_than_or_equal_to' => __( 'Handling amount must be 0 or greater.', 'surecart' ),
	'shipping_rate.calculatable.percent_handling.greater_than_or_equal_to' => __( 'Handling percentage must be 0 or greater.', 'surecart' ),
	...
	'fulfillment.invalid'                                  => __( 'Failed to save the fulfillment. Please check for errors and try again.', 'surecart' ),
	'fulfillment.shipments.parcel_template.blank'          => __( 'Please choose a saved package template for this shipment.', 'surecart' ),
	'fulfillment.shipments.dimensions.blank'               => __( 'Please provide the package length, width and height.', 'surecart' ),
	'fulfillment.shipments.weight.blank'                   => __( 'Please provide the package weight.', 'surecart' ),
	'fulfillment.shipments.weight.not_a_number'            => __( 'The package weight must be a number.', 'surecart' ),
	'fulfillment.shipments.g_weight.blank'                 => __( 'Please provide the package weight.', 'surecart' ),
	'fulfillment.shipments.g_weight.not_a_number'          => __( 'The package weight must be a number.', 'surecart' ),
	'shipment.invalid'                                     => __( 'Failed to update the shipment. Please check for errors and try again.', 'surecart' ),
	'shipment.parcel_template.blank'                       => __( 'Please choose a saved package template for this shipment.', 'surecart' ),
	'shipment.dimensions.blank'                            => __( 'Please provide the package length, width and height.', 'surecart' ),
	'shipment.weight.blank'                                => __( 'Please provide the package weight.', 'surecart' ),
	'shipment.weight.not_a_number'                         => __( 'The package weight must be a number.', 'surecart' ),
	'shipment.g_weight.blank'                              => __( 'Please provide the package weight.', 'surecart' ),
	'shipment.g_weight.not_a_number'                       => __( 'The package weight must be a number.', 'surecart' ),
);
