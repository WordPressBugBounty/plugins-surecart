<?php
/**
 * Product list block pattern where each card carries its own variant selector
 * and add to cart button, so a shopper can pick a size or colour and buy without
 * opening the product page. Cards for products without variants simply omit the
 * selector.
 */
return [
	'title'      => __( 'Product List with Variants', 'surecart' ),
	'categories' => [ 'surecart_shop' ],
	'blockTypes' => [ 'surecart/product-list' ],
	'priority'   => 1,
	'content'    => '<!-- wp:surecart/product-list {"limit":null,"query":{"perPage":9,"pages":0,"offset":0,"postType":"sc_product","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"include":[],"sticky":"","inherit":true,"taxQuery":null,"parents":[]},"metadata":{"categories":["surecart_shop"],"patternName":"surecart-list-variants","name":"Product List with Variants"},"align":"wide","style":{"spacing":{"blockGap":"10px","margin":{"left":"0px","right":"0px"}}}} -->
...
<!-- wp:surecart/product-variant-pills {"show_label":false,"max_visible_options":4,"style":{"spacing":{"margin":{"top":"12px"}}}} -->
<!-- wp:surecart/product-variant-pill {"style":{"typography":{"fontSize":"13px"},"spacing":{"padding":{"top":"4px","bottom":"4px","left":"10px","right":"10px"}}}} /-->
